...
| Field           | Description                                                                     |
| --------------- | ------------------------------------------------------------------------------- |
| Host            | Enter the host name for the MySQL database.<br/>For example: `db.company.com`   |
...
| Query                                           | Enter the SQL query to execute. The query will execute on the MySQL server and will fetch the data from it.<br/>For example:<br/>`select * from Employee`<br/>You can use the ** Query Helper** to help you write a usable SQL query. To use the ** Query Helper** , do the following:<br/>Select your database table and table columns in the appropriate menus.<br/>Copy the SQL statement that appears in the Query Helper field.<br/>Paste the copied SQL statement into the Query field.                                                                                                                                                                                                                                                                                                                                                                                                            |
