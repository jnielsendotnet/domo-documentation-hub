...
| タグ       | 属性                                                                                     |
| -------- | -------------------------------------------------------------------------------------- |
| `<a>`    | `href=" http://..." "` （下の注記1を参照）                                                      |
| `<br>`   |                                                                                        |
| `<div>`  | style （下の注記2を参照）<br/>align<br/>width<br/>title                                         |
| `<font>` | style （下の注記2を参照）<br/>color<br/>size                                                    |
| `<img>`  | style （下の注記2を参照）<br/>alt<br/>align<br/>border<br/>class<br/>height<br/>title<br/>width |
| `<span>` | `style` （下の注記2を参照）                                                                     |
| `<p>`    | `style` （下の注記2を参照）                                                                     |
| `<h1>`   | `style` （下の注記2を参照）                                                                     |
| `<h2>`   | `style` （下の注記2を参照）                                                                     |
