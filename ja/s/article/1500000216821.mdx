...
| Date Columns and Formats                   | 下で指定した日付列名とフォーマットを、ファイル内に存在する順に入力します。 <br/> 例：columnName1:dateFormat1,columnName2:dateFormat2 <br/> columnName1:dd-MM-yyyy,columnName2:MM-dd-yyyy |
