...
| フィールド        | 説明                                                                                                                |
| ------------ | ----------------------------------------------------------------------------------------------------------------- |
| Account Name | Snowflakeアカウント名を入力します。アカウント名を検索する方法については、「 [必要条件](#h_22fca4a7-63ae-411e-bd54-69b014fae6e3) 」を参照してください。            |
| Username     | Snowflakeアカウントに関連するユーザー名を入力します。                                                                                   |
| Private Key  | シークレットキーを入力します。シークレットキーの生成の詳細については、「 [パブリックキー/シークレットキーペアの設定](#h_01b2cc31-f12c-4c93-9df5-2f6493f7655a) 」を参照してください。 |
...
| パラメーター                              | 説明                                                                                                                                                                                                                                                                         |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Query                               | データを取得するために使用するSQLクエリを入力します。 **［Query Helper］** パラメーターを使用して、使用可能なSQLクエリを記述できます。 **［Query Helper］** を使用するには、以下を実行します。<br/>各メニューで、目的のウェアハウス、データベース、データベーススキーマ、データベース表、表の列を選択します。<br/>［Query Helper］ フィールドに表示されるSQLステートメントをコピーします。<br/>コピーしたSQLステートメントを ［Query］ フィールドに貼り付けます。 |
