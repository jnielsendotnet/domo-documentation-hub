...
1. ZIPファイルを保存したフォルダに移動し、以下の手順でWorkbenchノードをLinuxデーモンとして登録します。
...
1. Workbench Enterpriseの左側のナビゲーションで、
   **［ジョブ］** を選択します。
2. **［新規ジョブ］** を選択します。
...
2. Workbench Enterpriseで、<InlineImage src="/images/kb/ka0Vq000000GlhJ-00N5w00000Ri7BU-0EMVq0000038Ptx.jpg" /> **［管理者］** > **［Workbenchインポート］** に進みます。
...
3. <InlineImage src="/images/kb/ka05w0000012BE1-00N5w00000Ri7BU-0EM5w000006w7XZ.jpg" /> **［その他］** > **［実行］** の順に選択します。
...
2. ジョブの詳細の **［スケジュール］** タブで、 **［基本スケジュール］** または **［スケジュールの詳細設定］** タブの **［変更を監視］** というラベルの付いたチェックボックスをオンにすると、
   ...
   <Tip>
   **ヒント：** サードパーティツールでWorkbench Enterpriseジョブを起動する方法については [こちら](/ja/s/article/000005587) を参照してください。
