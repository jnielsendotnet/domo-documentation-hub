---
title: "Examples"
permalink: "9f2fe40b1bdb9-examples"
sidebarTitle: "Examples"
---
This page contains code examples for the Custom Connector sections that require JavaScript. The Connector Dev Studio has several built-in functions to make the process easier for you. For a list of these built-in JavaScript functions, see [Reference](/portal/e415bb99d21b2-reference).

* [User Authentication](/portal/9f2fe40b1bdb9-examples#user-authentication)
  + [No Authentication](/portal/9f2fe40b1bdb9-examples#No_Authentication)
  + [Username and Password](/portal/9f2fe40b1bdb9-examples#Username_and_Password)
  + [API Key](/portal/9f2fe40b1bdb9-examples#API_Key)
  + [OAuth 2.0](/portal/9f2fe40b1bdb9-examples#OAuth_2)
* [Discovery](/portal/9f2fe40b1bdb9-examples#discovery) (used in Configure Selectable Reports / Advanced Mode)
  + [Dropdown](/portal/9f2fe40b1bdb9-examples#Dropdown)
  + [Basic Tree Menu](/portal/9f2fe40b1bdb9-examples#basic-tree-menu)
  + [Nested Tree Menu](/portal/9f2fe40b1bdb9-examples#Nested_Tree_Menu)
* [Process Data Examples](/portal/9f2fe40b1bdb9-examples#process-data-examples)
  + [Sample CRM](/portal/9f2fe40b1bdb9-examples#sample-crm)
  + [Sample CRM using datagrid.magicParseCSV](/portal/9f2fe40b1bdb9-examples#sample-crm-using-datagridmagicparsecsv)
  + [USGS](/portal/9f2fe40b1bdb9-examples#usgs)
