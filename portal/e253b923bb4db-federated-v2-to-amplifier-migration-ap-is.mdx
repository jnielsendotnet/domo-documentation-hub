...
permalink: 'e253b923bb4db-federated-v2-to-amplifier-migration-ap-is'
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/federated-v2-to-amplifier-migration-apis/list-cloud-amplifier-integration-types"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/federated-v2-to-amplifier-migration-apis/list-cloud-amplifier-integrations-by-type"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/federated-v2-to-amplifier-migration-apis/list-datasource-migration-candidates-by-amplifier-integration"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/federated-v2-to-amplifier-migration-apis/migrate-datasource-to-amplifier-integration"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/federated-v2-to-amplifier-migration-apis/list-datasource-reverse-migration-candidates-by-amplifier-integration"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/federated-v2-to-amplifier-migration-apis/reverse-datasource-migration"
/>
