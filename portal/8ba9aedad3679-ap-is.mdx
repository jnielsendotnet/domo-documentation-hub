...
| ------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| App Framework | App Session Token | [App Sessions Guide](/portal/xma9hezmttvid-app-sessions)                                                         | Limited to endpoints explicitly allowed by the App Framework.                   |
...
- [AI Service Layer API](/portal/wjqiqhsvpadon-ai-service-layer-api)
