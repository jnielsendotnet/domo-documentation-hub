...
permalink: limitations-key-limitations
sidebarTitle: "Key Limitations"
stoplight-id: limitations
---
# Key Limitations
...
- Ensure that the user has the appropriate [permissions](/s/article/000005173?language=en_US#permissions) and [grants](/s/article/000005173?language=en_US#required_grants) enabled.
