---
title: 'Alerts API'
permalink: 'b09437e8d4d53-alerts-api'
sidebarTitle: 'Overview'
---

Domo Alerts allow users to subscribe to various events and receive timely notifications as changes occur. Find out more about Alerts by reading [this article](/s/article/360043430373?language=en_US). The Alerts API can be used to manage alerts in your Domo instance.
...
<Card
  ...
  title="Playground"
  icon="code"
  href="http://localhost:3000/api-reference/alerts-api/get-alerts"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="http://localhost:3000/api-reference/alerts-api/get-an-alert"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="http://localhost:3000/api-reference/alerts-api/delete-an-alert"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="http://localhost:3000/api-reference/alerts-api/subscribe-user-to-an-alert"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="http://localhost:3000/api-reference/alerts-api/unsubscribe-user-from-an-alert"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="http://localhost:3000/api-reference/alerts-api/share-an-alert"
/>
