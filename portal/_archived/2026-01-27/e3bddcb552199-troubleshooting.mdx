...
Sometimes developers confuse Typescript types (like "Number") with the column types that are supported for Domo DataSets. Instead, use “DOUBLE”, “LONG”, or “DECIMAL” types. Please refer to the [AppDB API](/portal/1l1fm2g0sfm69-app-db-api#defining-collections-in-the-manifest) documentation for the list of supported column types.
