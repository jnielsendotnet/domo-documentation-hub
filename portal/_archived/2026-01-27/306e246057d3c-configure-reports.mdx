...
sidebarTitle: "Configure Reports"
---
...
<Frame>![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/17133648/UserReports2.png)</Frame>
...
2. If you would like your custom connector to have additional parameters beyond the report name, click **Continue**. A Parameters section will appear.
   <Frame>![Configure Selectable Report](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/22041316/DateSelector.png)</Frame>
3. Click **Add Parameter**.
4. Enter a **Parameter Name** and **Help Text**. The Parameter Name will be the label for the field. The Help Text description for the new parameter will appear when the user clicks <Frame>![Help Icon](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/17141801/HelpIcon1.png)</Frame> next to the field.
...
7. Click **Configure** to add the JavaScript code necessary to use this option. For detailed information on how to write a discovery parameter, see [Write a Discovery Parameter](/portal/306e246057d3c-configure-reports#write-a-discovery-parameter).
...
<Frame>![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/15115333/Picture8.png)</Frame>
...
<Frame>![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2018/09/22050123/ProcessData.png)</Frame>
...
* **Dropdown**: Select this option if you would like the user to be able to select *only one* option. To add an option to the dropdown discovery object, use the function `discovery.addOption("Option Value")`. See the [Dropdown Discovery Example](/portal/306e246057d3c-configure-reports#dropdown-discovery-example).
* **Tree Menu**: Select this option if you would like the user to be able to select *multiple* options. It will appear as a series of checkboxes that can be nested in a tree structure. Use the function `discovery.addNode(<<parent node name>>, <<new node name>>)` to add a node. Use `discovery.addLeaf(<<parent node name>>, <<leaf name>>)` to add a leaf. Use the function `discovery.publishTree()` when you have completed adding nodes and leaves to the tree. See the [Tree Menu Discovery Examples](/portal/306e246057d3c-configure-reports#tree-menu-discovery-examples) below.
...
<Frame>![](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/02/Dropdown-Discovery.png)</Frame>
...
<Frame>![Advanced5](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/18131251/Advanced5.png)</Frame>
...
See [Reference](/portal/e415bb99d21b2-reference) for more information about these methods.
...
<Frame>![Basic Discovery Tree Menu](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/18101224/Advanced2.png)</Frame>
...
<Frame>![Nested Discovery Tree Menu](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/18130114/Advanced4.png)</Frame>
