...
sidebarTitle: "Query"
---
This is a simple library to create data query URLs for [Getting Domo data](/portal/6a5d7a2870145-getting-data). Use in conjunction with [domo.js](/portal/e947d87e17547-domo-js)).

## Dependencies

[Install domo.js](/portal/e947d87e17547-domo-js). This is preinstalled on all [DDX Bricks](/portal/0037739ab3747-domo-bricks-overview).
