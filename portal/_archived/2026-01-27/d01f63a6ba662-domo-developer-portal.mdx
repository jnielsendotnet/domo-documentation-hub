...
permalink: 'd01f63a6ba662-domo-developer-portal'
...
**[Explore our AI Resource Guide](/portal/0mnsejhg5livn-domo-ai-resources-guide)** to find out what's possible.
...
- **[Build your own custom connector](/portal/5d8f965eb3469-overview)**
- **[Connect with cross-cloud systems using Cloud Amplifier](/s/article/4412849158167?language=en_US)**
- **[Connect to on-prem data with Workbench](/portal/cb2e07663deaf-on-premises-data)**
- **[Use federated adapters to query data](/portal/2bd2767928a2e-federated-queries)**
...
- **[Push data via API](/portal/e0a20a74a7754-data-connection-via-api-overview)**
...
- **[Start simple with low-code Domo Bricks](/portal/0037739ab3747-domo-bricks-overview)**
- **[Go fully custom with Domo's App Framework](/portal/d54m2ohkacza0-welcome)**
...
3. Develop your listing - get a sense for **[what you can build here](/portal/600e2b5914564-domo-appstore)**.
4. **[Submit](/portal/d4f8eee792eb6-appstore-submission)** your app to the Appstore.
