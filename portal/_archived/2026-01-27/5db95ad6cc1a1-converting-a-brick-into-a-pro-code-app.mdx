...
<Frame>![The button is in the header of the brick editor, next to the COLLABORATORS button.](/images/dev/stoplight.io/images/where_to_find_convert_to_app_button.png)</Frame>
...
<Frame>![choosemanifest.png](/images/dev/stoplight.io/images/_assets_images_choosemanifest.png)</Frame>

### 4. Select your dataset from the modal:
<Frame>![choosedataset.png](/images/dev/stoplight.io/images/_assets_images_choosedataset.png)</Frame>
...
<Frame>![mapping.png](/images/dev/stoplight.io/images/_assets_images_mapping.png)</Frame>
* In this example, the alias we chose was “mapData” – you will need to update your API calls to use this alias for your dataset.
<Frame>![callalias.png](/images/dev/stoplight.io/images/_assets_images_callalias.png)</Frame>
...
<Frame>![manifestalias.png](/images/dev/stoplight.io/images/_assets_images_manifestalias.png)</Frame>
...
<Frame>![codebefore.png](/images/dev/stoplight.io/images/_assets_images_codebefore.png)</Frame>
<Frame>![codeafter.png](/images/dev/stoplight.io/images/_assets_images_codeafter.png)</Frame>
