...
<Frame>![asset_library](/images/dev/stoplight.io/images/asset-library-tutorial.png)</Frame>

Click on 'Pro-Code Editor' in the top right corner of your screen to open the editor in your browser.

<Frame>![pro_code_button](/images/dev/stoplight.io/images/procode-button.png)</Frame>

You can now edit the files in your project.
<Frame>![pro_code_editor](/images/dev/stoplight.io/images/procode-editor.png)</Frame>
...
<Frame>![code-engine-manifest](/images/dev/stoplight.io/images/code-engine-manifest.png)</Frame>
...
<Frame>![workflows-navigate](/images/dev/stoplight.io/images/workflows-navigate.png)</Frame>
<Frame>![code-engine-navigate](/images/dev/stoplight.io/images/code-engine-navigate.png)</Frame>

* Create a new Code Engine package, use Javascript as the language.

<Frame>![create-code-engine](/images/dev/stoplight.io/images/create-code-engine.png)</Frame>
<Frame>![name-language-code](/images/dev/stoplight.io/images/name-language-code.png)</Frame>
...
<Frame>![deploy](/images/dev/stoplight.io/images/deploy.png)</Frame>
...
<Frame>![get-cards](/images/dev/stoplight.io/images/get-cards.png)</Frame>
...
<Frame>![get-pdf](/images/dev/stoplight.io/images/get-pdf.png)</Frame>
...
<Frame>![page-pdf](/images/dev/stoplight.io/images/page-pdf.png)</Frame>
...
<Frame>![final-app](/images/dev/stoplight.io/images/final-app.png)</Frame>