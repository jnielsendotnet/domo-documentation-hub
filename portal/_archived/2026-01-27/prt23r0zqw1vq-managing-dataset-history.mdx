...
Requests to the endpoints in this document should be authenticated using an access token. The token should be passed using the `X-DOMO-Developer-Token` header. For information about generating an access token see [/s/article/360042934494?language=en_US](/s/article/360042934494?language=en_US).
