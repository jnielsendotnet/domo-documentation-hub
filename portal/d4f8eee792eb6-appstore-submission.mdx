...
sidebarTitle: "Appstore Submission"
---
**Note:** The ability to publish content is available by request. If you'd like to submit content to publish in Domo's Appstore, send an email with your name and instance URL to [appsubmissions@domo.com](mailto:appsubmissions@domo.com).
...
Please ensure that your app meets all the requirements in the [Appstore Requirements](/portal/c9db4daa8edfe-appstore-requirements) documentation before submitting your app to the Appstore. Apps built using Domo Stories and App Dev Framework will all follow these same procedures.

**Note:** If you are a Domo partner that is building an app, please reference the [Partner App Submission Guide](/portal/1420c2fd93550-partner-app-submission-guide) before you get started.
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-app-publishing-step-1.png)</Frame>

Once you are in the Domo Appstore select the **+** icon in the left navigation bar.

<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-start.png)</Frame>

**Note:** You will need to be sure you have publishing to the Domo Appstore enabled for you. If you don’t see the **+** icon in the left navigation bar contact us at [appsubmissions@domo.com](mailto:appsubmissions@domo.com) to have it turned on.
...
* **Enterprise App.** Publish a set of custom functionality built on top of [Domo’s App Developer Framework](/portal/d54m2ohkacza0-welcome).
* **Service.** Advertise any other service that can help a company or provide functionality for other apps to use.

<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-select-1.png)</Frame>
...
If you are submitting a paid app, please refer to the [Paid Apps](/portal/ea88871bcc736-paid-apps-guide) and [Getting Paid](/portal/ccdff47e23e23-getting-paid-guide) guides for more information.

<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-select-2.png)</Frame>

## Selecting content

**Note:** When submitting cards, custom charts, enterprise apps, and services you skip this step and go directly to [Name and Info](/portal/d4f8eee792eb6-appstore-submission#name-and-info).
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-page-select-dashboard.png)</Frame>

### **Code Blocks**

Select your code type and paste in your code selection.

<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-select-code-1.png)</Frame>

This is an example of a Beast Mode Code Block:

<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-select-code-2.png)</Frame>
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-name-info-1.png)</Frame>
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-publishing-details.png)</Frame>
...
You can also add up to 10 tags. Be sure to take a look at the [Appstore supported tags](/portal/c9db4daa8edfe-appstore-requirements#supported-tags) if you are unsure what tags to use.

<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-appstore-discovery.png)</Frame>
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-media.png)</Frame>
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-appstore-submission-preview.png)</Frame>
...
After submission, you can check the status of your app approval by emailing[appsubmissions@domo.com](mailto:appsubmissions@domo.com).
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-manage-apps-1.png)</Frame>
...
<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-manage-apps-2.png)</Frame>



<Frame>![](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-manage-apps-3.png)</Frame>
