...
sidebarTitle: "Filtering Options"
---
All these filter types are layered in the sequence below:

<Frame>![Filtering Options 1](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions1.png)</Frame>
...
<Frame>![Filtering Options 2](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions2.png)</Frame>

### Server-side Programmatic Filters

**Documentation:** [Programmatic Filtering](/portal/1yafxad1u8azv-programmatic-filtering)
...
<Frame>![Filtering Options 3](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions3.png)</Frame>
...
| /v1/filters/apply | Input | Event to communicate filters for an asset to apply | \{ id: 'setFilters123', jsonrpc: '2.0', method: '/v1/filters/apply', params: \{ filters: [\{'column': 'name', 'operand': 'IN', 'values': ['ABC']\}] \} \} | App Studio, Dashboard, Card |
| /v1/appData/apply | Input | Event to communicate "appData" to an app within the embed asset | \{  id: 'appData', jsonrpc: '2.0', method: '/v1/appData/apply', params: \{ appData: appData  \} \} | App Studio |
...
<Frame>![Filtering Options 4](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions4.png)</Frame>
...
<Frame>![Filtering Options 5](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions5.png)</Frame>
...
[Using Pfilters to Apply Filters from URL Query Parameters to Embedded Dashboards](/portal/buk5zwk1pvjwh-url-parameters-in-embedded-content#pfilters)
...
<Frame>![Filtering Options 7](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions7.png)</Frame>
...
<Frame>![Filtering Options 8](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions8.png)</Frame>
...
<Frame>![Filtering Options 9](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/08/FilteringOptions9.png)</Frame>
