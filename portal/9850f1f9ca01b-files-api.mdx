...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/upload-a-file"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/upload-a-file-revision"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/get-all-files-metadata"
...
```javascript
async function getFileDetailsList(userId = null,
  expand = null,
  dataFileIds = null,
) {
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/get-file-metadata-by-id"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/get-revision-metadata-by-id"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/get-all-file-revisions-by-id"
/>
**Method:** `GET`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/download-a-file-revision"
/>
**Method:** `GET`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/copymove-a-file"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/duplicate-a-file"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/delete-a-file"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/delete-a-file-revision"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/get-file-permissions"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/files-api-product/update-file-permissions"
