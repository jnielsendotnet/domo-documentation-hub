...
After installing Workbench, the directory

C:\Program Files\Domo\Workbench\SDK

will contain the SDK documentation along with a Visual Studio plugin and sample project.
...
<Frame>![plugin manager screen](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-wokbench5-ui.png)</Frame>
