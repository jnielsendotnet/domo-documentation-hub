...
sidebarTitle: "Import And Export Data"
---
...
In order to import or export data you must first have a DataSet created. To learn how to create a DataSet, utilize the [DataSet Quickstart](/portal/278e9d611eaa6-quickstart).
...
As you begin the process of importing your data we we recommend you first [review Domo's data format specifications](/portal/eb00606e6f114-format-data-to-import) before you import.
...
<Frame>![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2016/06/08181204/StreamsAPIFlow-1024x402.png)</Frame>
...
In order to utilize this Quickstart you will need to obtain an [access token](/portal/uc9ls4li6ny8s-embed-token-api) or you can leverage any of [Domo's SDKs](/portal/e04caa9abb5cc-domo-sd-ks) which will also handle authentication.
