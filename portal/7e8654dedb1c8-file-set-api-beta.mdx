...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/get-file-by-path"
/>
...
<CodeGroup>
```js Javascript (domo.get)
domo
  .get(`/domo/files/v1/filesets/${filesetId}/path?path=${encodeURIComponent(filePath,
    )}`,
  )
...
```js Javascript (fetch)
fetch(`/domo/files/v1/filesets/${filesetId}/path?path=${encodeURIComponent(filePath,
  )}`,
)
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/get-file-by-id"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/download-file-by-id"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/query-files"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/upload-file"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/search-files-in-fileset"
/>
...
domo
  .post(`/domo/files/v1/filesets/${filesetId}/files/search?directoryPath=reports&limit=20`,
    {
...
// Example 2: Advanced search with directory path and filters
fetch(`/domo/files/v1/filesets/${filesetId}/files/search?directoryPath=reports&immediateChildren=true&limit=20`,
  {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/delete-file-by-path"
/>
...
```js Javascript (domo.delete) 
domo
  .delete(`/domo/files/v1/filesets/${filesetId}/path?path=${encodeURIComponent(filePath,
    )}`,
  )
  .then((result) => {
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/delete-file-by-id"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/search-filesets"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/create-fileset"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/get-fileset-by-id"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/update-fileset-by-id"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/fileset-api-beta/delete-fileset-by-id"
/>
