...
permalink: "ff85f1d956ae2-task-center-api"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/get-queues"
/>
...
const getQueues = async (combineAttributes = true, archived = false) => {
  const queues = await domo.get(`/api/queues/v1/?combineAttributes=${combineAttributes}&archived=${archived}`
  );
  return queues;
};
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/get-queue-by-id"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/get-tasks"
/>
...
const getTasks = async (body) => {
  const queue = await domo.post(`/api/queues/v1/tasks/list?render=true&renderParts=NAME,DESCRIPTION,MAPPING,METADATA,VERSIONS`,
    body
  );
  return queue;
};
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/get-task-by-id"
/>
...
const getTaskByID = async (queueId, taskId) => {
  const task = await domo.get(`/api/queues/v1/${queueId}/tasks/${taskId}?render=true`
  );
  return task;
};


const task = getTaskByID("168ecd84-4a15-45f6-89d9-021fbbce0481",
  "18OCT23_1JUTZM"
);
```
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/save-task-progress"
/>

#### Code Example

<Frame>![Screenshot 2024-01-02 at 8.50.40 AM.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Screenshot-2024-01-02-at-8.50.40-AM.png)</Frame>
...
const saveTask = async (queueId, taskId, body) => {
  const task = await domo.put(`/api/queues/v1/${queueId}/tasks/${taskId}/outputs`,
    body
  );
  return task;
};
...
const task = saveTask("168ecd84-4a15-45f6-89d9-021fbbce0481",
  "18OCT23_1JUTZM",
  body
);
```
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/complete-task"
/>
#### Code Example
...
const completeTask = async (queueId, taskId, body) => {
  const task = await domo.post(`/api/queues/v1/${queueId}/tasks/${taskId}/complete?version=1`,
    body
  );
  return task;
};
...
const task = completeTask("168ecd84-4a15-45f6-89d9-021fbbce0481",
  "24OCT23_CI27D1",
  body
);
```
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/transfer-task"
/>
...
const transferTask = async (currentQueueId, taskId, newQueueId) => {
  const task = await domo.put(`/api/queues/v1/${currentQueueId}/tasks/${taskId}/move?targetQueueId=${newQueueId}`
  );
  return task;
};


const task = transferTask("bca21fad-e06b-4905-b43a-ea0929850e47",
  "13AUG24_RZY4WA",
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/transfer-task-to-another-user"
/>
...
const transferTaskToUser = async (currentQueueId, taskId, body) => {
  const task = await domo.put(`/api/queues/v1/${queueId}/tasks/${taskId}/assign`,
    body
  );
  return task;
};
...
const task = transferTaskToUser("bca21fad-e06b-4905-b43a-ea0929850e47",
  "13AUG24_RZY4WA",
  body
);
```
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/void-a-task"
/>
...
const voidedTask = async (queueId, taskId) => {
  const task = await domo.post(`/api/queues/v1/${queueId}/tasks/${taskId}/void`
  );
  return task;
};


const task = voidedTask("bca21fad-e06b-4905-b43a-ea0929850e47",
  "13AUG24_RZY4WA"
);
```
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/task-center-api-product/update-permissions"
/>
