...
Task Center allows you to organize manual tasks into different queues of work and control who can access them. They are often used in concert with [Workflows](/s/article/000005108?language=en_US).

For more [background on Task Center, please see the Knowledge Base](/s/article/000005172?language=en_US).
...
<Frame>
  ...
  AM.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Screenshot-2024-01-02-at-8.50.40-AM.png)
</Frame>
