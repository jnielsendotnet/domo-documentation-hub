...
For this tutorial, we will use yarn as a node package manager, but you can follow the instructions from the [create-react-app documentation](https://create-react-app.dev/docs/getting-started#creating-an-app) to install a new react app with the `@domoinc` template based on the package manager of your choice (`npx`, `yarn`, or `npm`). Before starting, make sure you've successfully installed the Domo Apps CLI and completed the `domo login` command to authenticate against your instance of Domo.
...
[AppDB](/portal/1l1fm2g0sfm69-app-db-api) is a nosql database for storing arbitrary JSON documents, we can use it to persist data in our app.
...
<Frame>![yarn_upload_output.png](/images/dev/yarn_upload_output.png)</Frame>
...
<Frame>![create_card.png](/images/dev/create_card.png)</Frame>

We need to map the collection we added to the `manifest.json`. Click "Select Collection".

<Frame>![select_collection.png](/images/dev/select_collection.png)</Frame>

Since we are creating the collection for the app, let's create a new one by clicking on "Create New".

<Frame>![Screenshot 2024-05-15 at 10.49.19 AM.png](/images/dev/Screenshot-2024-05-15-at-10.49.19-AM.png)</Frame>

Click "Create Collection" to start with an empty collection.

<Frame>![Screenshot 2024-05-15 at 10.51.20 AM.png](/images/dev/Screenshot-2024-05-15-at-10.51.20-AM.png)</Frame>

After creating the collection we can save the card.

<Frame>![save_collection.png](/images/dev/save_collection.png)</Frame>
...
<Frame>![proxy.png](/images/dev/proxy.png)</Frame>
...
const TasksEmptyState = () => (<div className={styles.List__empty}>You have no tasks</div>
);
...
export const TaskListITem = ({ task, onCheck, onTaskClick }) => (<div>
    <div className={styles.Main__wrapper}>
      <div className={styles.Row_content_wrapper}>
        ...
        <div className={styles.Row__content}>
          {task.status === 'completed'? (<div className={styles.Row__completedTask__subtitle}>
              {task.title}
            </div>
          ): (<div
        ...
        <div className={styles.TaskForm__formBoxContent}>
          ...
          <div>
            <input
              ...
              onChange={(event) =>
                handleStagedTaskUpdate('dueDate',
...
<Frame>![Screenshot 2024-07-18 at 3.40.01 PM.png](/images/dev/Screenshot-2024-07-18-at-3.40.01PM.png)</Frame>


<Frame>![Screenshot 2024-07-18 at 3.40.52 PM.png](/images/dev/Screenshot-2024-07-18-at-3.40.52PM.png)</Frame>
...
<Frame>![Screenshot 2024-07-18 at 3.42.47 PM.png](/images/dev/Screenshot-2024-07-18-at-3.42.47PM.png)</Frame>
