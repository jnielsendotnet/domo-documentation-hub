...
<Frame>![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2018/01/08164723/ActivityLog1.png)</Frame>
...
**NOTE:** In order to utilize this Quickstart you will need to obtain an [access token](/portal/uc9ls4li6ny8s-embed-token-api#quickstart).
