...
| Platform      | API Client        | [Creating a Developer Client and Auth Token](/portal/Getting-Started/api-authentication) | Limited to a subset of all Product endpoints that can be given scopes.          |
