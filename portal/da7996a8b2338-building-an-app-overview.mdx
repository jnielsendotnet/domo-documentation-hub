---
title: "Building an App Overview"
permalink: "da7996a8b2338-building-an-app-overview"
sidebarTitle: "Building An App Overview"
---
## 1. Define your app
...
App visualizations are powered by datasets that reside in Domo. One of the first steps to building an app is getting data. This [guide](/portal/b836f5593ab26-getting-data) on getting data will walk you through some of the fundamental tools and features to acquire and transform data.
...
Gain ultimate flexibility and develop your own custom visualizations using HTML, CSS, JavaScript, and just about any web technology. [Learn More](/portal/d54m2ohkacza0-welcome)
...
Apps can be shared with the entire Domo Appstore Ecosystem, which allows all Domo users the ability to download and populate the app with their own data. [Learn More](/portal/600e2b5914564-domo-appstore)