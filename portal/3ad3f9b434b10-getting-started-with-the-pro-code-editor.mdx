...
<Frame>![asset-library.png](/images/dev/asset-library-tutorial.png)</Frame>
...
<Frame>![template.png](/images/dev/template.png)</Frame>
...
<Frame>![save-template.png](/images/dev/save-template.png)</Frame>
...
<Frame>![workspace-options.png](/images/dev/workspace-options.png)</Frame>

* **Keyboard Shortcuts**: Access available keyboard shortcuts by selecting **Help** in the dropdown menu under the Domo logo.

<Frame>![keyboard.png](/images/dev/keyboard.png)</Frame>
...
<Frame>![file-explorer.png](/images/dev/file-explorer.png)</Frame>
...
<Frame>![open-preview.png](/images/dev/open-preview.png)</Frame>

* **Hide/Show Preview**: Toggle the preview section on or off as needed to give yourself more screen space.

<Frame>![preview.png](/images/dev/preview.png)</Frame>
...
<Frame>![resize-preview.png](/images/dev/resize-preview.png)</Frame>
...
<Frame>![refresh.png](/images/dev/refresh.png)</Frame>
...
<Frame>![custom-size.png](/images/dev/custom-size.png)</Frame>
