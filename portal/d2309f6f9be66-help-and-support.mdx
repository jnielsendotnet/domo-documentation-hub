...
<AccordionGroup>
<Accordion title="How do I access the IDE?">
...
<Accordion title="How do I designate the corresponding icon for this connector?">
...
<Accordion title="How long is the beta / trial period for the custom connector?">
...
<Accordion title="What should I do in case my connector is rejected?">
...
<Accordion title="If I resubmit my custom connector, will my newly submitted connector be eligible for another 14 day trial / review period?">
...
<Accordion title="What happens after the 14 day trial period expires?">
...
<Accordion title="So will all connectors now have a 14 day trial review period, regardless if it’s public or private facing?">
...
<Accordion title="Will I be able to retract my submission?">
...
<Accordion title="What will happen if I withdraw and resubmit my custom connector within the 14 day trial period?">
...
<Accordion title="It’s been more than 14 days and I have not heard anything from the Domo Custom Connector team. Who can I contact for help?">
...
<Accordion title="Are all custom connectors available for self-publication and 14 day trial period?">
...
<Accordion title="What is the SLA for the review process turn-around time?">
