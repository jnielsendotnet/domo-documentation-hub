...
- For more information about creating the CLIENT_ID and CLIENT_SECRET review the details in the following link: [API Authentication Overview](/portal/Getting-Started/api-authentication)
