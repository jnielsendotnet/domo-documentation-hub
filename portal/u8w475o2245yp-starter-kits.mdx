---
title: "Starter Kits"
permalink: "u8w475o2245yp-starter-kits"
...
* Use the [domoapps cli](/portal/6hlzv1hinkq19-setup-and-installation) to login to your Domo instance with `domo login`
...
* If you intend to use endpoints provided by the App Platform (e.g. datasets, AppDB, etc), make sure to also add a `proxyId` to the `manifest.json` file in your `public` folder. See [proxy documentation](/portal/af407395c766b-the-manifest-file#getting-a-proxyid-advanced) for more info.
...
## Prerequisites
You'll need the [Angular CLI](http://cli.angular.io/) installed in order to run the `ng add` command.
