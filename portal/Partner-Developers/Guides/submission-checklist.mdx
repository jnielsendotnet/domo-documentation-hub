...
- List of external libraries (name, version number, URI, and publisher) and
  other hosted resources in this application. Save this list as 'external_resources.txt' in the app main directory.
...
- Tags—check the [list of supported tags](/portal/Partner-Developers/Domo-Marketplace/marketplace-data-resources#supported-tags) for details
- Description—must address the main business question and include high-level application of the app; check [Domo Appstore Requirements](/portal/Partner-Developers/Domo-Marketplace/marketplace-requirements) for more details
...
- Dataset names must begin with 'SAMPLE\_' in their name
