...
[<Frame>![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/08/09100910/PageVisuals.png)</Frame>](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/08/09100910/PageVisuals.png)
...
* [Controlling Access in Domo](https://knowledge.domo.com/Administer/Controlling_Access_in_Domo)
* [Specifying Default Overview Content for Users](https://domohelp.domo.com/hc/en-us/articles/360043439153-Specifying-Default-Overview-Content-for-Users)
* [Applying Page Level Filters](https://knowledge.domo.com/Optimize/Filtering_Data/02Applying_Page-Level_Filters)
...
1. Create a page
2. Create page collections
3. Share a page with users or groups

Once a page is created, you can continue to programmatically update it's content and access.
<Note>

**NOTE:** 
In order to utilize this Quickstart you will need to obtain an [access token](/portal/uc9ls4li6ny8s-embed-token-api#quickstart) or you can leverage any of [Domo's SDKs](/portal/e04caa9abb5cc-domo-sd-ks) which will also handle authentication.
...
See this sample request in [Java](https://github.com/domoinc/domo-java-sdk/blob/master/domo-java-sdk-all/src/test/java/com/domo/sdk/pages/CreateExample.java), [Python](https://github.com/domoinc/domo-python-sdk/blob/master/examples/page.py).
...
See this sample request in [Java](https://github.com/domoinc/domo-java-sdk/blob/master/domo-java-sdk-all/src/test/java/com/domo/sdk/pages/CollectionCreateExample.java), [Python](https://github.com/domoinc/domo-python-sdk/blob/master/examples/page.py).
...
See this sample request in [Java](https://github.com/domoinc/domo-java-sdk/blob/master/domo-java-sdk-all/src/test/java/com/domo/sdk/pages/UpdateExample.java), [Python](https://github.com/domoinc/domo-python-sdk/blob/master/examples/page.py).
