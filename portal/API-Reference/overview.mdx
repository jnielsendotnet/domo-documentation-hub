...
| Platform      | API Client        | [Creating a Developer Client and Auth Token](/portal/API-Reference/overview) | Limited to a subset of all Product endpoints that can be given scopes.          |
