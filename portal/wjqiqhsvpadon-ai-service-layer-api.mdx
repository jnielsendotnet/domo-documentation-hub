...
permalink: "wjqiqhsvpadon-ai-service-layer-api"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/ai-service-layer-api/text-generation"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/ai-service-layer-api/text-to-sql"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/ai-service-layer-api/image-to-text-ocr"
/>
