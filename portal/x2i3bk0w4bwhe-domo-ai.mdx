...
* [**Forecasting in a Domo App**](https://domo-support.domo.com/s/article/000005567?language=en_US#forecasting_in_app): The Forecasting Universal Model allows you to easily add a forecast to a line or bar chart on a card in a Domo app. You can use App Studio to input the seasonality of your data and the number of time points you would like to forecast — all without having to build a forecasting model from scratch. The forecast is automatically added to your card along with two confidence interval ranges.
  *Note: This capability is currently in Alpha. Please contact your AE or CSM to get access.*
  <Frame>![My Image](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Forecasting_Domo_App.png)</Frame>
...
<Frame>
<iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" frameborder="0" height="113" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin" src="https://www.youtube.com/embed/zaCSgsjjp7M?start=392&amp;feature=oembed" title="Domo + AI: From Aspiration to Implementation" width="200" style={{width: "100%", height: "100%"}}></iframe>
</Frame>
...
<Frame>
<iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" frameborder="0" height="113" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin" src="https://www.youtube.com/embed/Mk83Dk7QEvg?start=25&amp;feature=oembed" title="Domopalooza 2024 | Ask the AI Experts: Q&amp;A Panel Session With Domo" width="200" style={{width: "100%", height: "100%"}}></iframe>
</Frame>
...
<Frame>
<iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" frameborder="0" height="113" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin" src="https://www.youtube.com/embed/JCFkPcwMZY0?start=1226&amp;feature=oembed" title="AI Readiness: Is Your Organization Ready to Embrace AI?" width="200" style={{width: "100%", height: "100%"}}></iframe>
</Frame>
...
#### [Considerations When Choosing a Large Language Model (LLM)](#considerations-when-choosing-a-large-language-model-llm)
...
* [AI Service Layer App Framework APIs](/portal/wjqiqhsvpadon-ai-service-layer-api)
