...
![The button is in the header of the brick editor, next to the COLLABORATORS button.](/images/dev/stoplight.io/images/where_to_find_convert_to_app_button.png)
