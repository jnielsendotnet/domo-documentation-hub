...
const generatePlan = async (gamesOwned) => {
  const prompt = `Please write me an agenda for a fun and engaging game night that lasts between 3 and 4 hours and includes some of the following games: ${JSON.stringify(
    gamesOwned,
  )}. Please use plenty of puns.`;
...
```js
var generatePlanButtonContainer = document.getElementById(
  'generate-plan-button-container',
);
```
...
![Screenshot 2024-03-25 at 6.56.15 AM.png](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-6.56.15-AM.png)

**Bonus challenge**: add some css to our button to make it look a bit nicer.

![Screenshot 2024-03-25 at 7.03.38 AM.png](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.03.38-AM.png)
...
<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.19.11-AM.png)
</Frame>

**Bonus challenge #2**: Add some css to make our game night plan container display better.

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.25.51-AM.png)
</Frame>
...
<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.41.16-AM.png)
</Frame>

Click "Create App" and pick your theme:

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.42.02-AM.png)
</Frame>
...
<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.43.58-AM.png)
</Frame>

Let's drop our Custom app on this page. Click the + button and drag the Card icon into the canvas.

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.44.36-AM.png)
</Frame>

Click "Add Existing Card" and search for the App Instance ("Card") you've been building.

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.47.00-AM.png)
</Frame>
...
<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.49.18-AM.png)
</Frame>

Select the same Dataset powering our App.

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.50.05-AM.png)
</Frame>

Select a filter card:

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.50.37-AM.png)
</Frame>

I'm going to create a playing time filter so I can more easily narrow games down by playing time.

<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.51.56-AM.png)
</Frame>
...
<Frame>
  ![](/images/dev/stoplight.io/images/Screenshot-2024-03-25-at-7.58.59-AM.png)
</Frame>
...
- Try adding integration with Workflows to send an email invitation to your friends. See our [Guide on Hitting a Workflow from an App](/portal/Apps/App-Framework/Guides/hitting-a-workflow)
- Try taking an action in a third party system. Refactor your app into a "Game Recommendation Application" and write a Code Engine function that add a Board Game you don't already own to a shopping cart in an ecommerce site. See our Guide on [Hitting Code Engine from an App](/portal/Apps/App-Framework/Guides/hitting-code-engine-from-an-app)
- Try building your application with more advanced tooling like our [React Starter Kit](/portal/Apps/App-Framework/Quickstart/Starter-Kits).
