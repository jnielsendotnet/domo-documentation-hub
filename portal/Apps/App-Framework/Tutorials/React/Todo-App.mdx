...
For this tutorial, we will use yarn as a node package manager, but you can follow the instructions from the <a href="https://create-react-app.dev/docs/getting-started#creating-an-app">create-react-app documentation</a> to install a new react app with the `@domoinc` template based on the package manager of your choice (`npx`, `yarn`, or `npm`). Before starting, make sure you've successfully [installed the Domo Apps CLI](/portal/Apps/App-Framework/Quickstart/Setup-and-Installation) and completed the `domo login` command to authenticate against your instance of Domo.
...
[AppDB](/portal/API-Reference/app-framework-apis/AppDB-API) is a nosql database for storing arbitrary JSON documents, we can use it to persist data in our app.
...
![yarn_upload_output.png](/images/dev/stoplight.io/images/yarn_upload_output.png)
...
![create_card.png](/images/dev/stoplight.io/images/create_card.png)

We need to map the collection we added to the `manifest.json`. Click "Select Collection".

![select_collection.png](/images/dev/stoplight.io/images/select_collection.png)

Since we are creating the collection for the app, let's create a new one by clicking on "Create New".

![Screenshot 2024-05-15 at 10.49.19 AM.png](/images/dev/stoplight.io/images/Screenshot-2024-05-15-at-10.49.19-AM.png)

Click "Create Collection" to start with an empty collection.

![Screenshot 2024-05-15 at 10.51.20 AM.png](/images/dev/stoplight.io/images/Screenshot-2024-05-15-at-10.51.20-AM.png)

After creating the collection we can save the card.

![save_collection.png](/images/dev/stoplight.io/images/save_collection.png)
...
![proxy.png](/images/dev/stoplight.io/images/proxy.png)
...
![Screenshot 2024-07-18 at 3.40.01 PM.png](/images/dev/stoplight.io/images/Screenshot-2024-07-18-at-3.40.01-PM.png)

![Screenshot 2024-07-18 at 3.40.52 PM.png](/images/dev/stoplight.io/images/Screenshot-2024-07-18-at-3.40.52-PM.png)
...
![Screenshot 2024-07-18 at 3.42.47 PM.png](/images/dev/stoplight.io/images/Screenshot-2024-07-18-at-3.42.47-PM.png)
