...
Initialize a React project using Domo's template by following the steps in this [quickstart guide](/portal/Apps/App-Framework/Quickstart/Starter-Kits).
...
- The `manifest.json` file is a special Domo file that is required for building apps on the Domo App Framework. [What is the manifest file?](/portal/Apps/App-Framework/Guides/manifest)
...
Review our docs for the [AI Service Layer API](/portal/API-Reference/app-framework-apis/AI-Service-Layer-API) to find out what else you can do.
