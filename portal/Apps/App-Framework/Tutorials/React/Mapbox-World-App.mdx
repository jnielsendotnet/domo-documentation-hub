...
Before beginning, please make sure you’ve successfully installed the Domo Apps CLI and followed the basic setup and installation instructions found [here](/portal/Apps/App-Framework/Quickstart/Setup-and-Installation). When following the article, please skip `Step 3: Create a New App`. We will be creating a React app instead of a simple Javascript app.

Initialize a React project using Domo's template by following the steps in [this article](/portal/Apps/App-Framework/Quickstart/Starter-Kits).
...
- The `manifest.json` file is a special Domo file that is required for building apps on the Domo App Framework. We will use this file to wire our app to a dataset in Domo. [What is the manifest file?](/portal/Apps/App-Framework/Guides/manifest)
...
![mapbox-globe.png](/images/dev/stoplight.io/tutorials/mapbox-globe.png)
...
![mapbox-cartesian.png](/images/dev/stoplight.io/tutorials/mapbox-cartesian.png)
...
![mapbox-sample-points.png](/images/dev/stoplight.io/tutorials/mapbox-sample-points.png)
...
![dataset-id-example.png](/images/dev/stoplight.io/tutorials/dataset-id-example.png)
...
![app-upload-success.png](/images/dev/stoplight.io/tutorials/app-upload-success.png)
...
![asset-example.png](/images/dev/stoplight.io/tutorials/asset-example.png)
...
![asset-card-example.png](/images/dev/stoplight.io/tutorials/asset-card-example.png)
...
We are going to use the Domo CLI (aka `ryuu.js` from within an app) to fetch data from our instance. [What is the Domo CLI?](/portal/Apps/App-Framework/Tools/domo-js)
...
We are using the Data API for the App Framework, which is [documented here](/portal/API-Reference/app-framework-apis/Data-API). This `GET` endpoint uses the dataset `alias`, which we set in our `manifest.json` file. We set the `alias` as `geoData`, but you can set it to whatever you'd like.
...
![mapbox-finished.png](/images/dev/stoplight.io/tutorials/mapbox-finished.png)
