---
title: 'Local Development with Domo CLI'
permalink: c8adeafafc236-local-development-with-domo-cli
---
...
<Note>
  If you have already created an app with [App
  Catalyst](/portal/Apps/App-Catalyst/getting-started-app-catalyst), you can
  just make sure you're in the project directory, and go straight to [Step 3:
  Initial Local Development](#step-3:-initial-local-development).
</Note>
...
- [Domo CLI installed](/portal/Apps/App-Framework/Tools/domo-CLI#installation)
...
If you haven't installed the Domo CLI yet, you can install it by following the [Setup and Installation Guide](/portal/Apps/App-Framework/Tools/domo-CLI#installation).
...
\*Developer Access Tokens (Developer Tokens) are secure API keys assigned to a specific user in your Domo instance. You can get more information and obtain a developer access token by following the [Access Token Guide](/s/article/360042934494?language=en_US).
...
See our guide on [The Manifest File](/portal/Apps/App-Framework/Guides/manifest) for more information.
...
**Need a quick thumbnail?** You can use this [sample thumbnail](/images/dev/stoplight.io/images/thumbnail-procode.png) as a starting point.
...
See our guide on [The Manifest File](/portal/Apps/App-Framework/Guides/manifest#getting-a-proxyid-advanced) for more information.
...
- Explore the [Domo Apps CLI documentation](/portal/Apps/App-Framework/Tools/domo-CLI) for more advanced features
