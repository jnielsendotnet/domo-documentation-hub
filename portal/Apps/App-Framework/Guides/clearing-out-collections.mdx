---
title: 'Deleting all documents from a collection'
permalink: clearing-deleting-all-documents-from-a-collection
sidebarTitle: 'Clearing a Collection'
stoplight-id: clearing
---
