---
title: Query Library
permalink: d5da72027f4a1-query
---

[![npm version](https://img.shields.io/npm/v/@domoinc/query.svg)](https://www.npmjs.com/package/@domoinc/query)

This is a simple library to create data query URLs for [Getting Domo data](/portal/Apps/App-Framework/Guides/getting-data). Use in conjunction with [domo.js](/portal/Apps/App-Framework/Tools/domo.js).

## Installation

The Query library is available on [npm](https://www.npmjs.com/package/@domoinc/query)
