...
- **[Domo Bricks](/portal/Apps/DDX-Bricks/overview) (previously DDX Bricks)**: Domo Bricks are pre-built objects that allow you to create advanced visualizations and apps that can be customized in a simple browser-based code editor.
...
**[Domo Bricks](/portal/Apps/DDX-Bricks/Quickstart/overview) (previously DDX Bricks)** are a great tool for quickly customizing Domo if your use-case can be achieved by:
