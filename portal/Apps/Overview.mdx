...
- **[Domo Bricks](/portal/Apps/App-Framework/DDX-Bricks/Quickstart/overview) (previously DDX Bricks)**: Domo Bricks are pre-built objects that allow you to create advanced visualizations and apps that can be customized in a simple browser-based code editor.
- **[App Framework](/portal/Apps/App-Framework/Welcome)**: The Domo App Framework provides a set of APIs for building custom JavaScript-based front-ends on Domo and a transactional database called AppDB, which is a wrapper on top of MongoDB.
...
**[Domo Bricks](/portal/Apps/App-Framework/DDX-Bricks/Quickstart/overview) (previously DDX Bricks)** are a great tool for quickly customizing Domo if your use-case can be achieved by:
...
As the complexity of your app grows, the full **[App Framework](/portal/Apps/App-Framework/Welcome)** tooling is the way to go. This may be because:
...
- Your app involves data collection via [CRUD](https://developer.mozilla.org/en-US/docs/Glossary/CRUD) operations (Create, Read, Update, Delete), which requires Domo's built-in transactional datastore called [AppDB](/portal/API-Reference/app-framework-apis/AppDB-API).
...
- Your app requires the ability to interface with the [Files API](/portal/API-Reference/app-framework-apis/Files-API).
...
- You'd like to leverage JavaScript frameworks like [React, Angular, or Vue](/portal/Apps/App-Framework/Quickstart/Starter-Kits).
