---
title: "Managing Dataset History"
permalink: "prt23r0zqw1vq-managing-dataset-history"
sidebarTitle: "Overview"
---
### Authentication

Requests to the endpoints in this document should be authenticated using an access token. The token should be passed using the `X-DOMO-Developer-Token` header. For information about generating an access token see [https://domo-support.domo.com/s/article/360042934494?language=en_US](https://domo-support.domo.com/s/article/360042934494?language=en_US).
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/managing-dataset-history-api/listing-dataset-versions"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/managing-dataset-history-api/deleting-dataset-versions"
/>
