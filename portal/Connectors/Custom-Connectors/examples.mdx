...
This page contains code examples for the Custom Connector sections that require JavaScript. The Connector Dev Studio has several built-in functions to make the process easier for you. For a list of these built-in JavaScript functions, see [Reference](/portal/Connectors/Custom-Connectors/reference).
...
- [User Authentication](#user-authentication)
  ...
  - [API Key](#api-key)
  - [OAuth 2.0](#oauth-2-0)
- [Discovery](#discovery) (used in Configure Selectable Reports / Advanced Mode)
  - [Dropdown](#dropdown)
  - [Basic Tree Menu](#basic-tree-menu)
  - [Nested Tree Menu](#nested-tree-menu)
- [Process Data Examples](#process-data-examples)
  - [Sample CRM](#sample-crm)
  - [Sample CRM using datagrid.magicParseCSV](#sample-crm-using-datagrid-magicparsecsv)
  - [USGS](#usgs)
