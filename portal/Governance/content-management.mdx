...
permalink: content-organize-manage-and-share-content-to-other-users-in-domo-using-the-page-api
sidebarTitle: "Organize, manage, and share content to other users in Domo using the Page API"
stoplight-id: content
---
