...
<Frame>![The button is in the header of the brick editor, next to the COLLABORATORS button.](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/where_to_find_convert_to_app_button.png)</Frame>

<Note>

#### Dataset Configuration Transfer

Notice that upon converting, the datasets you had wired previously have **automatically** been **transferred** to your [manifest.json](https://developer.domo.com/portal/af407395c766b-the-manifest-file)
...
Bricks use the `window.datasets` global property to execute a Configuration-driven design paradigm, while the Pro-Code Editor leverages a [manifest.json](https://developer.domo.com/portal/af407395c766b-the-manifest-file) file to implement a Metadata-driven design strategy.

To make the switch, you'll need to **replace** any usages of `window.datasets` with the corresponding dataset **aliases** (found in your [manifest.json](https://developer.domo.com/portal/af407395c766b-the-manifest-file)).
...
<Frame>![choosemanifest.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_choosemanifest.png)</Frame>

### 4. Select your dataset from the modal:
<Frame>![choosedataset.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_choosedataset.png)</Frame>

### 5. Create an alias for the dataset ID
* This will be used to humanize your API calls to the [DataSet endpoint(s)](/portal/8s3y9eldnjq8d-data-api). 
<Frame>![mapping.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_mapping.png)</Frame>
* In this example, the alias we chose was “mapData” – you will need to update your API calls to use this alias for your dataset.
<Frame>![callalias.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_callalias.png)</Frame>
...
<Frame>![manifestalias.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_manifestalias.png)</Frame>
...
<Frame>![codebefore.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_codebefore.png)</Frame>
<Frame>![codeafter.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/_assets_images_codeafter.png)</Frame>
