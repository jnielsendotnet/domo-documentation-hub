...
<Frame>![mapbox-globe.png](/images/dev/stoplight.io/tutorials/mapbox-globe.png)</Frame>
...
<Frame>![mapbox-cartesian.png](/images/dev/stoplight.io/tutorials/mapbox-cartesian.png)</Frame>
...
<Frame>![mapbox-sample-points.png](/images/dev/stoplight.io/tutorials/mapbox-sample-points.png)</Frame>
...
<Frame>![dataset-id-example.png](/images/dev/stoplight.io/tutorials/dataset-id-example.png)</Frame>
...
<Frame>![app-upload-success.png](/images/dev/stoplight.io/tutorials/app-upload-success.png)</Frame>
...
<Frame>![asset-example.png](/images/dev/stoplight.io/tutorials/asset-example.png)</Frame>
...
<Frame>![asset-card-example.png](/images/dev/stoplight.io/tutorials/asset-card-example.png)</Frame>
...
<Frame>![mapbox-finished.png](/images/dev/stoplight.io/tutorials/mapbox-finished.png)</Frame>
