---
title: "Mapbox World Map React App Tutorial"
permalink: "cf7d0861d9e10-mapbox-world-map-react-app-tutorial"
sidebarTitle: "Mapbox World App"
---
...
function App() {
  ...
  return (<div id="map-container" className="mapContainer" ref={mapContainerRef} />
  );
}
...
<Frame>![mapbox-globe.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/mapbox-globe.png)</Frame>
...
<Frame>![mapbox-cartesian.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/mapbox-cartesian.png)</Frame>
...
<Frame>![mapbox-sample-points.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/mapbox-sample-points.png)</Frame>
...
<Frame>![dataset-id-example.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/dataset-id-example.png)</Frame>
...
<Frame>![app-upload-success.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/app-upload-success.png)</Frame>
...
<Frame>![asset-example.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/asset-example.png)</Frame>
...
<Frame>![asset-card-example.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/asset-card-example.png)</Frame>
...
function App() {
  ...
  const getPointRadius = (row) => {
    const step = Math.min(Math.floor((row.dataPoint - POPULATION_LIMIT) / POINT_STEP),
      3
    );
    return 1 + step * 0.2;
  };
...
<Frame>![mapbox-finished.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/tutorials/mapbox-world-app/mapbox-finished.png)</Frame>
