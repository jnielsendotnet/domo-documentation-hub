---
title: "Hitting a Code Engine Function from an App"
permalink: "4w40o03817vij-hitting-a-code-engine-function-from-an-app"
sidebarTitle: "Hitting Code Engine From An App"
---
...
In order to be able to hit a Code Engine function from an app, you need to add a `packageMapping` definition to your app’s [manifest file](/portal/af407395c766b-the-manifest-file) and then wire up a code engine function to the app in the wiring screen. To be able to test your code engine function locally, please also make sure that you have [configured your app with a `proxyId`](/portal/af407395c766b-the-manifest-file#getting-a-proxyid-advanced).
...
<Frame>![Screenshot 2024-02-13 at 2.30.40 PM.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Screenshot-2024-02-13-at-2.30.40-PM.png)</Frame>
...
<Frame>![Screenshot 2024-02-13 at 2.31.16 PM.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Screenshot-2024-02-13-at-2.31.16-PM.png)</Frame>

Next, click "Select Package". This will open a modal to choose your package.

<Frame>![Screenshot 2024-02-13 at 2.32.29 PM.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Screenshot-2024-02-13-at-2.32.29-PM.png)</Frame>

Finally, choose your package, version, function, and map input parameters.

<Frame>![Screenshot 2024-02-13 at 2.34.02 PM.png](/images/dev/stoplight.io/api/v1/projects/cHJqOjI2NDA4OA/branches/YnI6MTE1MjI3Mjk/images/assets/images/Screenshot-2024-02-13-at-2.34.02-PM.png)</Frame>
