...
permalink: "ffvznqc76b2b5-ai-services-api"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/ai-services/text-generation"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/ai-services/text-to-sql"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/ai-services/text-summarization"
/>
