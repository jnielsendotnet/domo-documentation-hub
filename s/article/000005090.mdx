...
| Menu    | Description                                                                                                                                                                     |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report  | Select the report you want to run. The following reports are available:<br/>統計表表示IDで取得 Retrieve a statistics table by its ID. Statistics table is a dataset provided by e-Stat. |
