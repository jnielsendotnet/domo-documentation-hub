...
* [Access Observability Metrics](#access_observability_metrics)
* [Required grants](#required_grants)
* [Add a Domo access token account](#adding_domo_access_token)
  + [Generate an access token](#generate_access_token)
* [Create a job](#create_job)
* [Schedule a job](#schedule_job)
* [Run a job](#run_job)
* [Clone a job](#clone_job)
...
1. **Create Custom Pipeline Processes —**
...
2. **Administer Custom Pipeline Processes —**
   Allows you to create, update, share, and delete jobs.
...
To learn more about custom roles and grants, see [Manage User Roles and Grants](https://domo-support.domo.com/s/article/360043438973?language=en_US).
...
2. From the left side rail, select
   <InlineImage src="/images/kb/ka0Vq000000N0H3-00N5w00000Ri7BU-0EMVq000005LMh0.jpg" /> **Accounts.**
3. Select
   **+ Add New** > **Account** to open the **Add Account** modal.
4. In the modal, search for and select
   **Domo Access Token**.
     
   Two options display for creating an account. Only one option is required.
     
   1. With an access token. To generate an access token, follow the steps in the section below (see Generating Access Tokens). Then, return to this task and paste the token into the
...
4. In the
   ...
   * Enter the URL of the instance (*domain*. [domo.com](http://domo.com) ). Remember to include " [domo.com](http://domo.com)" at the end of your URL.
...
7. (Optional) To add multiple reports, select
...
You can manually run a job by selecting <InlineImage src="/images/kb/ka0Vq000000N0H3-00N5w00000Ri7BU-0EMVq000005KDFx.jpg" /> **Job Options** > **Run Job.**
...
2. Hover over a job in the list. Select
   <InlineImage src="/images/kb/ka0Vq000000N0H3-00N5w00000Ri7BU-0EMVq000005KDW5.jpg" /> **Job Options** > **Clone.** The **Clone Job** modal displays.
3. Enter a name, optional description, instance URL, and select the instance's
