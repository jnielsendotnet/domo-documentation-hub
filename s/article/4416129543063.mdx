...
| How Would You Like To Select Your Table?                     | {" "}
 ...
 to.{" "}                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Table Name                                                   | Select how you want to name the table where data will be copied.<br/>DataSet ID 
...
| Delete Existing Table and Create New Table For The Same Name | {" "}
 ...
 If instead, you want us to drop the existing table and create a new table with this name, then check this checkbox.{" "}<br/>**WARNING** 
