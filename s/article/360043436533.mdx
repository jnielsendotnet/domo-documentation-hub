...
| Access Token                     | Enter the developer token for the DataSet you are copying data from. |
...
| Field                       | Description                                                                                                                                                                                                                                              |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DataSource ID               | Enter the Domo DataSource ID of the DataSet to pull data from. The DataSource ID is the GUID in the URL of the DataSet, immediately after /datasources/.                                                                                                 |
| Domo Instance               | Enter the Domo instance name.<br/>For example, in [https://abc123.domo.com](https://abc123.domo.com), abc123 is the instance.                                                                                                                            |
