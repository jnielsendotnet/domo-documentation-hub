...
| Report                          | {" "}
 ...
 report you want to run. The following reports are available:{" "}<br/><table border="1" cellpadding="1" cellspacing="1">
...
| {" "}
 JQL Query{" "}           | Enter a JQL query to pull custom data. 


 [{" "}
 Jira Documentation{" "}](https://confluence.atlassian.com/display/JIRA/Advanced+Searching)
.{" "}<br/>{" "}
...
| {" "}
 Sublists To Flatten{" "} | Enter the sublists to be flattened.<br/>{" "}
