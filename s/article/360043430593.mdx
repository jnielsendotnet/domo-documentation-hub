...
1. Select
   <InlineImage src="/images/kb/ka05w00000124Tr-00N5w00000Ri7BU-0EM5w000005vPKS.png" /> **> Approvals**.
...
4. Do one of the following:
   ...
   * To *share access* to the request, click on the <InlineImage src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNm2.png" /> and select **Edit observers**.
   * To *edit* the request, click on the <InlineImage src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNm2.png" />, select **Edit request**, make your changes, then click **Save**.
   * To *request changes, delegate, or deny*, click on the <InlineImage src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNm2.png" />, then select the action you wish to take.
