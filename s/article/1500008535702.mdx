...
4. Enter the following details in
   **Job Details** section.
   ...
   | **Field**      | **Description**                                                                                                                                                                               |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Domo Domain    | Select the desired account (Domo instance) in the **Domo Domain** dropdown menu.<br/>If you have only one account set up, that account is already chosen for you and the menu is unavailable. |
| Job Name       | Enter a name for the DataSet Job.<br/>This is the job name that appears in Workbench, not the name of the uploaded DataSet in Domo.                                                           |
...
| DataSet Description | Enter a description for the DataSet, if desired.<br/>This is the description of the DataSet as it appears in Domo.                                            |
...
| Domain              | Enter your SharePoint Windows domain name.<br/>Example: If your SharePoint site was located at [https://sample.sharepoint.com](https://sample.sharepoint.com), your domain name would be “sample”. |
