...
| Menu                       | Description                                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report                     | Select the Amazon Athena JDBC 2.0 report you want to run.<br/><table border="1" cellpadding="1" cellspacing="1"><tbody><tr><td colspan="1" rowspan="1"><p> Query </p></td><td colspan="1" rowspan="1"><p> Let's you query data from a specified S3 database and table. </p></td></tr><tr><td colspan="1" rowspan="1"> Query Parameter </td><td colspan="1" rowspan="1"> Enter an SQL query with a parameter. </td></tr></tbody></table> |
...
| Query Parameter            | Enter the query parameter value. It is the initial value for query parameter. The last run date is optional. By default, it is '02/01/1700' if is not provided.<br/>Example: `!{lastvalue:_id}!=1,!{lastvalue:gender}!='male',!{lastrundate:start_date}!=02/01/1944`                                                                                                                                                                    |
...
| Convert BigInt to Integer  | Select this check box if you want to convert the BIGINT columns into Integer.                                                                                                                                                                                                                                                                                                                                                           |
