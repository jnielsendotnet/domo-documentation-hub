...
| Menu                  | Description                                                                                                                                                                                                                                                                |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Enter the DataSet ID  | Enter the id of your Domo dataset containing data to write to Emarsys Sales. The ID is located in the dataset URL.<br/>Example: [https://customer.domo.com/datasources/](https://customer.domo.com/datasources/)**aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee** /details/settings |
| Emarsys Setup         | Enter the needed details for Emarsys.                                                                                                                                                                                                                                      |
| Configuration Mapping | Map dataset fields and Emarsys Sales fields.<br/>For required fields, select the matching dataset columns.<br/>For optional field, enter the desired Emarsys Sales field and select the matching dataset columns.                                                          |
