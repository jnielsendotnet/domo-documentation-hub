...
| Direct Upload      | Specify whether Workbench should or should not directly upload your output file to Domo. <br/><Note>**Note:** The direct upload option is only available for CSV files. See [Direct Upload in Workbench](/s/article/360047538593) for more information. </Note> |
