...
This article describes how to troubleshoot the following common errors when using Beast Mode calculations:

* [Case statement formatting](#case_statement_formatting)
* [Date formatting](#date_formatting)
* [Field name vs. string value vs. numeric value](#field_name_string_value_numeric_value)
* [Strings compared to dates](#strings_compared_to_dates)
* [Use of trim function](#trim_function)
