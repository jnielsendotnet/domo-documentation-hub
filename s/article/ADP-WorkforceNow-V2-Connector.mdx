...
The Client ID and Client Secret act as the Username and Password for your application to identify itself to ADP's authorization server. 
...
**Why is the ADP Certificate needed?**
