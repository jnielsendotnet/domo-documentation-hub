...
2. It is important to note that some of the tiles have changed their functionality. For more information, see [Magic ETL v2 DataFlow Optimizations](/s/article/360051062653 "Magic ETL v2 DataFlow Optimizations (Beta)").
...
<Warning>
  ...
  **MUST**
  ...
  [Upgrading to Magic ETL v2](/s/article/360047787514 "Upgrading to Magic ETL v2 (Beta)")
