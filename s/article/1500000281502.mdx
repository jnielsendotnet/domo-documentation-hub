...
| Menu          | Description                                                                                                                                                                                                                                                                                                                                       |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report        | Select the Amazon Athena Unload report you want to run. Currently, only one report type is available.<br/><table border="1" cellpadding="1" cellspacing="1"><tbody><tr><td colspan="1" rowspan="1"><p> Query </p></td><td colspan="1" rowspan="1"><p> Let's you query data from a specified S3 database and table. </p></td></tr></tbody></table> |
