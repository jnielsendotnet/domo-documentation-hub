...
* [Roadmap](#roadmap)
* [Use case — example agent](#use_case)
* [More agent ideas](#more_agent_ideas)
* [Prompt engineering references](#prompt_engineering_references)
...
* Knowledge Base Agent<br/><br/>
  Use all the articles in the [Domo Knowledge Base](https://domo-support.domo.com/s/knowledge-base?language=en_US) and the data in our [community](https://community-forums.domo.com/main) <InlineImage src="/images/kb/ka0Vq000000D8pN-00N5w00000Ri7BU-0EMVq000007QkWD.jpg" /> to create a Domo Agent that customers and partners can use to ask questions when trying to build something in Domo.
...
* [Anthropic](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) <InlineImage src="/images/kb/ka0Vq000000D8pN-00N5w00000Ri7BU-0EMVq000007QkWD-1.jpg" />
* [OpenAI](https://platform.openai.com/docs/guides/text?api-mode=responses#prompt-engineering) <InlineImage src="/images/kb/ka0Vq000000D8pN-00N5w00000Ri7BU-0EMVq000007QkWD-2.jpg" />
* [AWS](https://aws.amazon.com/what-is/prompt-engineering/) <InlineImage src="/images/kb/ka0Vq000000D8pN-00N5w00000Ri7BU-0EMVq000007QkWD-3.jpg" />