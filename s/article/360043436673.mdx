...
| Menu                                 | Description                                                                                                                                                                                     |
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Connection Type                      | Select the type of connection you would like to make. The options include:<br/>HTTP Request<br/>File Transfer (SFTP)<br/>Upload file containing JSON data                                       |
