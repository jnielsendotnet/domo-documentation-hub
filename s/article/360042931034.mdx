...
| **Primary Use Cases**                                     | This connector gives you the when, where, and magnitude for recent earthquake activity (as far back as 1 month).                                                       |
| --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Field  | Description                                                                                 |
| ------ | ------------------------------------------------------------------------------------------- |
| Report | Select whether you want to retrieve earthquake data for the last hour, day, week, or month. |
