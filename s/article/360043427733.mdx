...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| <img src="/images/kb/ka05w00000124T8-00N5w00000Ri7BU-0EM5w000005vNgJ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/><br/> Inner       | Includes only matching rows in both input DataSets.                                                                          |
| <img src="/images/kb/ka05w00000124T8-00N5w00000Ri7BU-0EM5w000005vNg9.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/><br/> Left Outer  | Includes all rows from the first input DataSet (on the left) and matching rows from the second input DataSet (on the right). |
| <img src="/images/kb/ka05w00000124T8-00N5w00000Ri7BU-0EM5w000005vNgE.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/><br/> Right Outer | Includes all rows from the second input DataSet (on the right) and matching rows from the first input DataSet (on the left). |
| <img src="/images/kb/ka05w00000124T8-00N5w00000Ri7BU-0EM5w000005vNgG.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/><br/> Full Outer  | Includes all rows from both input DataSets.                                                                                  |
