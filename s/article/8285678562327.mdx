...
| Empty Column Headers    | Specify what should happen if empty column headers are encountered. <br/> If you choose to **Add blank columns**, column names are automatically generated for the new columns. |
