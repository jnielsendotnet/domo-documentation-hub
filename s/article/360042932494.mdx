...
| Select Filename                                                   | Select how you want to choose the file where data will be copied.<br/>Use Input DataSet GUID . The filename will be the number you entered for Input DataSet ID .<br/>Use Input DataSet Name . The filename will be the same as that of the input DataSet.<br/>Enter File Name . You will give the file a custom name in the File Name field.                                                                                                                                                                         |
