...
| SQL Data type for String Values  | Select an SQL data type for the string values. <br/>**Note**: The default data type is VARCHAR. Please select NVARCHAR if the source data contain Unicode characters. Also, the data type may only work if a new table is created, or an existing table is overwritten with new data.                                                                                                                                                                                                                        |
| SQL Data type for Integer Values | Select an SQL data type for the integer values. <br/>**Note**: The data type may only work if a new table is created, or an existing table is overwritten with new data.                                                                                                                                                                                                                                                                                                                                     |
