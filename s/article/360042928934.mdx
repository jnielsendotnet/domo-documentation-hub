...
| Field                 | Description                                                                                                                                |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Oracle Service        | Enter the name of the Oracle service you want to connect to. For more information about locating your service, see "Prerequisites," above. |
| Database Username     | Enter your Oracle database username.                                                                                                       |
| Database Password     | Enter your Oracle database password.                                                                                                       |
| Base64 Encoded Wallet | Enter the copied text from the `encoded_wallet.txt` file. For more information about generating this file, see "Prerequisites," above.     |
