...
| Schema Name     | Select ' **With Schema Name** ' option for populating the 'DATABASE SCHEMA NAMES' discovery and on the selection of the schema name it will populate the table discovery.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Fetch Size      | Enter the fetch size for memory performance. If the field is blank, then the default value will be 1000. If it throws out of memory for a value, then decrease the fetch size.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
