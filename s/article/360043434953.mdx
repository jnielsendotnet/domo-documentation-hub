...
| Report   | Select the Google Calendar report you want to run. The following reports are available:<br/><table border="1" cellpadding="1" cellspacing="1"><tbody><tr><td colspan="1" rowspan="1"> ACL Feeds </td><td colspan="1" rowspan="1"> Returns the rules in the access control list for the calendar. </td></tr><tr><td colspan="1" rowspan="1"> Calendar Event Entries </td><td colspan="1" rowspan="1"> Returns events from the selected calendar. </td></tr></tbody></table> |
