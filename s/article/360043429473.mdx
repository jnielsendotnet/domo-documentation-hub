...
This article describes how to manage Pivot Tables in Domo in the following topics:

* [Pivot Table capabilities](#PivotTableCapabilities)
* [Power Pivot Tables](#power_pivot_tables)
* [Customize Pivot Tables](#customize_pivot_tables)
  + [Pivot Table properties](#pivot_table_properties)
  + [General properties](#general_properties)
  + [Header row properties](#header_row_properties)
  + [Header column properties](#header_column_properties)
  + [Totals properties](#totals_properties)
  + [Subtotals properties](#subtotals_properties)
  + [Specify table labels](#specify_table_labels)
  + [Change the aggregation type for a column](#change_aggregation_type)
  + [Sort rows and columns](#sort_rows_and_columns)
* [Best practices for Pivot Tables](#best_practices)
