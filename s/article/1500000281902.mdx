...
| User ID                            | Your Data.World User ID. You can find your user ID under your profile icon below your user name, in the upper right corner of the screen.<br/>**Note**: *The "@" sign is not a part of your user ID. Please do not include "@" while entering your user id.* |
...
| Enter the User ID       | Enter the User ID you want to fetch the data for.<br/><Note>**Note:** The User ID is only visible if you select the Public Dataset option in the Dataset Type. Note that the User ID entered here is the creator of the Public DataSet you want to fetch. **Example**: To discover a public DataSet created by a user XYZ, you need to enter XYZ as the user ID. </Note> |
...
| Custom Query            | Enter the SQL query to execute based on the selected dataset. If your table contains space or hyphens then replace them with an underscore.<br/>Example: If the table name is **Sample-Data Info** then it will become **Sample_Data_Info**                                                                                                                              |
