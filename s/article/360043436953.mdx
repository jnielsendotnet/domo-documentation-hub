...
| Select Table Name | Select how you want to name the table where data will be copied.<br/>Use Input DataSet ID As Table Name . The table name will be the number you entered for Input DataSet ID .<br/>Use Input DataSet Name as Table Name . The table name will be the same as that of the input DataSet.<br/>Custom Name . You will give the table a custom name in the Custom Table Name field.                                                                                                                               |
