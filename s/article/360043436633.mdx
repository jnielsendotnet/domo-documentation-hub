...
| --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Primary Metrics**                                       | Users can create a wide variety of metrics using Google Sheet DataSets. Some frequently used metrics are...<br/>Tracking a list of items<br/>People<br/>Help requests<br/>Company assets<br/>Employee compliance / trainings |
...
| Force To String            | Enter a comma separated list of columns in the selected worksheet that you would like to import as text fields. |
| Date Format                | Select the date format which is used in the selected file.                                                      |
