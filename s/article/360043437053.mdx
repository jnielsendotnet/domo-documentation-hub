...
| Certificate        | {" "}
 ...
 is required.{" "}                                |
| Certificate Type   | {" "}
 Select a certificate type. This must match what you enter in the **Certificate** field. If you are not aware
 of a special certificate, select **No certificate**.{" "} |
...
| Table Name Source   | Choose how the SQL table should be named.<br/>DataSet ID: The table name will be the number you entered for DataSet ID .{" "}<br/>DataSet Name: The table name will be the same as that of the input DataSet.{" "}<br/>Custom Name: You will give the table a custom name in the Custom Table Name field.{" "}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Table Update Method | {" "}
 When you select the 
 **Operation Type** as 
 **Update an Existing Table**, the 
 **{" "}
 Table Update Method{" "}** 
 field appears. <br/> Select how you want to update the database table:{" "}<br/><table border="1">
          <tbody>
            <tr>
              <td colspan="1" rowspan="1">
                <b> Field </b>
