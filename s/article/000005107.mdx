...
| Field              | Description                                                                                                                                                                                                                                                      |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Connection String  | Enter the connection Url for your MongoDB. <br/> Use <username> and <password> as placeholder for your actual username and password. <br/>*mongodb://<username>:<password>@examphost1:port1,examphost2:port2/?connectionParam1=value1&connectionParam2=value2..* |
