...
* [Prerequisites](#prerequisites)
   + [Recommended account creation — all](#recommended_account_creation)
   + [Account creation — Write](#account_creation_write)
* [Read-only setup](#read_only_setup)
* [Write setup](#write_setup)
* [Use Snowflake-sourced DataSets](#use_snowflake_sourced_datasets)
* [Snowflake connection security](#snowflake_connection_security)
   + [Snowflake key-pair authentication](#snowflake_key-pair_authentication)
   + [OAuth configuration](#oauth_configuration)
      
      - [Configure OAuth in Snowflake](#configure_oauth_in_snowflake)
      - [Configure OAuth in Domo](#configure_oauth_in_domo)
      - [Configure Okta for SSO access](#configure_okta_for_sso)
* [FAQ](#faq)
