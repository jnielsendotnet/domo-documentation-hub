...
* [Add a Drill Path to a chart](#add_a_drill_path_to_a_chart)
* [Edit an existing Drill Path](#edit_an_existing_drill_path)
* [Reorder a Drill Path](#reorder_a_drill_path)
* [Prevent drilling to the data layer](#prevent_drilling_to_data_layer)
* [Delete a View from a Drill Path](#delete_a_view_from_a_drill_path)
* [Use Case 1](#use_case)
* [Use Case 2](#use_case_2)
* [Drill between maps](#drill_between_maps)
...
2. Click
   <InlineImage src="/images/kb/ka05w00000123Qn-00N5w00000Ri7BU-0EM5w000005vOAc.png" />, then select **Edit Drill Path**.
...
4. (Optional) Select a different DataSet by doing the following:
   ...
   1. Click
      <InlineImage src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzV.png" /> next to the DataSet name.
