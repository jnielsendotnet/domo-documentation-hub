...
* [Variables — terms to know](#variables_terms)
* [Variables and the Beast Mode editor](#beast_mode_editor)
* [Create a Variable](#create_a_variable)
* [Add a Variable to a Beast Mode calculation](#add_variable_to_beast_mode)
* [Edit/delete a Variable](#edit_delete)
* [Controls](#controls)
  + [Default Control](#default_control)
  + [Create a Default Control](#create_a_default_control)
  + [Card Variable Controls](#card_variable_controls)
    - [Modify a Card Variable Control](#modify_card_variable_control)
  + [Dashboard Variable Controls](#dashboard_variable_controls)
    - [Add a Dashboard Variable Control](#add_dashboard_variable_control)
    - [Modify a Dashboard Variable Control](#modify_dashboard_variable_control)
    - [Page Filters](#page_filters)
* [Variables and Governance](#variables_and_governance)
* [Lock/unlock a Variable](#lock_unlock)
* [DomoStats reports](#domostats_reports)
* [FAQ](#faq)
* [Variables use cases and feature walkthrough (video)](#video)
...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:209;a"><thead><tr><th colspan="1" rowspan="1"><p> Term </p></th><th colspan="1" rowspan="1"><p> Definition </p></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"><p> Variable </p></td><td colspan="1" rowspan="1"><p> A value that functions inside of a Beast Mode. </p><p> Similar to variables in math, Variables can be of different data types and various kinds, depending on controls. </p></td></tr><tr><td colspan="1" rowspan="1"><p></p><p> Default value </p></td><td colspan="1" rowspan="1"><p> The default value of a Variable is set when the Variable is created. </p></td></tr><tr><td colspan="1" rowspan="1"><p> Value </p></td><td colspan="1" rowspan="1"><p> The value of a Variable can change, depending on your modifications. </p></td></tr><tr><td colspan="1" rowspan="1"><p> Control </p></td><td colspan="1" rowspan="1"><p> The way that you can interact with and modify the value of a Variable. </p><p> There are three types of Variable controls: <a href="#h_01GET8B1S7MG2RQ59142P27J8A" target="_self"> Default Controls </a>, <a href="#h_01GET8BA5RNV3AY68XVRT1N6W7" target="_self"> Card Variable Controls </a>, and <a href="#h_01GET8BMF2CAP4FP1KRVRJYTGC" target="_self"> Dashboard Variable Controls </a>. <a id="beast_mode_editor" target="_blank"></a></p></td></tr></tbody></table>
...
You can <InlineImage src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl8.png" /> **Edit** or <InlineImage src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl3.png" /> **Delete** a Variable from its place in the **Variables** tab.

It is possible to lock a Variable so that it can't be edited or deleted. To learn more, see [Variables and Governance](#variables_and_governance).
...
1. Are you creating a new Variable?
    ...
    + **No —** In the **Variables** tab of the Beast Mode Editor, locate the Variable you want to create a Default Control for and select <InlineImage src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl8.png" /> **Edit.**
...
To lock a Variable that you create, when you are creating the Variable in the Beast Mode Editor, locate the <InlineImage src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXkv.png" /> **Lock** under **Variable Settings**.

Select <InlineImage src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXkv.png" /> **Lock** before saving your Variable.

Now, no other users can edit or delete your Variable unless you unlock it.

Unlock the Variable by selecting <InlineImage src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlD.png" /> **Unlock** under **Variable Settings**.
