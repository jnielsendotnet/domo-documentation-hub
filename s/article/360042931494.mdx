...
3. Select **Get the Data**.
   ...
   <Frame><img alt="get the data.jpg" src="/images/kb/ka0Vq00000006LZ-00N5w00000Ri7BU-0EM5w000006wRKk.jpg" style={{width: 900, height: 477}}/></Frame>
...
5. Paste the link you just copied into the appropriate location in your third-party application.
   ...
   <Frame><img alt="json_webhook_3rd_party_url.png" src="/images/kb/ka0Vq00000006LZ-00N5w00000Ri7BU-0EM5w000005vO0I.png" style={{width: 750, height: 567}}/></Frame>
...
6. Also in the third-party application, be sure to set the content type to "application/json."
   ...
   <Frame><img alt="json_webhook_3rd_party_content_type.png" src="/images/kb/ka0Vq00000006LZ-00N5w00000Ri7BU-0EM5w000005vO0J.png" style={{width: 750, height: 567}}/></Frame>
...
<iframe allowfullscreen="allowfullscreen" frameborder="1" height="315" src="//www.youtube-nocookie.com/embed/W9Xsoii26kQ" width="560"></iframe>
</Accordion>
</AccordionGroup>