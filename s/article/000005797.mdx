...
* [Shapes](#shapes)
  ...
  + [Custom function](#custom_function)
    - [Map the input parameters](#map_input_parameters)
    - [Map the output parameters](#map_outputs)
    - [Edit, exchange, or remove a function](#edit_exchange_or_remove_a_function)
    - [Test a custom function](#test_a_function)
  + [Query table](#query_table)
* [Data types](#data_types)
  + [Defined object](#defined_object)
  + [Open object](#open_object)
