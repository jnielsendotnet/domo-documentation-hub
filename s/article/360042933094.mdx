...
| Refresh                | Refreshes the Domo content in this Word document.                                                                                                                                                                                                                   |
| Help                   | Lets you see the version number for this version of Domo Word as well as check for newer versions.                                                                                                                                                                  |
...
| Pages/Subpages                                                                                                                                                                          | Provide access to the Cards and/or subpages located under them. Indicated using the <img src="/images/kb/ka0Vq000000DxtV-00N5w00000Ri7BU-0EM5w000005vOUg.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon.                                                                                                                        |
| Cards                                                                                                                                                                                   | Let you open Cards in the sidebar, broken down into their individual components (such as visual content, summary number, etc.), which you can drag into your Word document as desired. Indicated using the <img src="/images/kb/ka0Vq000000DxtV-00N5w00000Ri7BU-0EM5w000005vOUq.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon. |
| Apply Page Filters                                                                                                                                                                      | Determines whether page filters are applied to the pages listed in the sidebar.                                                                                                                                                                                                                                                                                                      |
| Refresh Button <br/><img src="/images/kb/ka0Vq000000DxtV-00N5w00000Ri7BU-0EM5w000005vOUd.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> | Allows you to refresh the list of pages appearing in the sidebar.                                                                                                                                                                                                                                                                                                                    |
