...
| Menu                             | Description                                                                                                                                                                                                                                                                                                                                                               |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report                           | Select the BigQuery report type to run. The following reports are available:<br/><table class="mt-responsive-table"><tbody><tr><td class="mt-noheading" colspan="1" rowspan="1"><p> Query </p></td><td class="mt-noheading" colspan="1" rowspan="1"><p><span> Runs a BigQuery SQL query and returns results if the query completes. </span></p></td></tr></tbody></table> |
...
| Force to Number                  | E nter a comma separated list of fields that need to be treated as NUMBER in Domo.                                                                                                                                                                                                                                                                                        |
