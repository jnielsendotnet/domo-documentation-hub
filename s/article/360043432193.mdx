...
| Menu                       | Description                                                                                                                                                                                                                                                                                                                                         |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report                     | Select the ClickPoint report you want to run. Currently only one report type is available.<br/><table border="1" cellpadding="1" cellspacing="1"><tbody><tr><td colspan="1" rowspan="1"><p> Leads </p></td><td colspan="1" rowspan="1"><p> Returns all leads for the given account API key. </p></td></tr></tbody></table>                          |
