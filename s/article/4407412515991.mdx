...
| Menu                                   | Description                                                                                                                                                                                             |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report                                 | <table border="1"><tbody><tr><td colspan="1" rowspan="1"> Contacts </td><td colspan="1" rowspan="1"> Write data from Domo to Emarsys contacts. </td></tr></tbody></table>                               |
| Enter a dataset to map the fields here | Enter the id of your Domo dataset containing data to write to Emarsys Contacts.                                                                                                                         |
| Enter the DataSet ID                   | The ID is located in the dataset URL.<br/>Example: [https://customer.domo.com/datasources/](https://customer.domo.com/datasources/)**aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee** /details/settings           |
