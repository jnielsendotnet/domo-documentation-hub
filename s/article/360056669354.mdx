...
1. In the **Jobs** pane, click the **+** icon to create a new job.
   ...
   <Frame>
     <img alt="1.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU2.png" />
   </Frame>
...
1. In the **Configure** subtab for the job:
   ...
   1. Provide the source of the data in the **Source** menu. For example, if the data source was a local file, you would select the file path here.
      ...
      <Frame>
        <img alt="2.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPTw.png" />
      </Frame>
...
2. You can schedule a DataSet job to routinely upload data from external DataSets to Domo. You can select a **Basic Schedule** (update manually, update when file is changed, or update on a schedule.) Or, you can opt for an **Advanced Schedule** (once a day, specific days of the week/month, etc.) You can also select the **Schedule mode** to be in **Local time** (of your server/Workbench machine) or **UTC time**. You can also see the next five scheduled run times for the job.
   ...
   <Frame>
     <img alt="Schedule_Workbench.png" src="/images/kb/ka05w00000129sa-00N5w00000Ri7BU-0EM5w000005wL6w.png" />
   </Frame>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/W94Yw-d6FmY"
  width="560"
></iframe>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/d5Av1ZqPDDI"
  width="560"
></iframe>
...
<Frame>
  <img alt="3.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUK.png" />
</Frame>
...
<Frame>
  <img alt="4.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUE.png" />
</Frame>
...
- The Protect column provides you a control to protect or unprotect all columns with a single click. Select the checkbox next to the column header (Protect) to protect all your columns at once. Similarly, you can unprotect your columns at the same time by deselecting this checkbox.
  {" "}
  <InlineImage src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUX.png" /> <InlineImage src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUO.png" />
...
- You can change the names or properties for the Destination Column and the Data Type column, but in order for these changes to take effect, the column will need to be unprotected.
  ...
  {" "}
  <Frame>
    <img alt="10.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUG.png" />
  </Frame>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/tps1Tycqp4U"
  width="560"
></iframe>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/OuTTHdy5Caw"
  width="560"
></iframe>
...
<Frame>
  <img alt="11.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUI.png" />
</Frame>
...
<Frame>
  <img alt="12.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPTu.png" />
</Frame>
...
<Frame>
  <img alt="14.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUL.png" />
</Frame>

The output window will appear showing the preview for errors for your job.

<Frame>
  <img alt="15.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUA.png" />
</Frame>
...
- Click the **Open Log Viewer** button.
  {" "}
  <Frame>
    <img alt="16.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUT.png" />
  </Frame>

The Domo Workbench Log Viewer window will appear displaying the detailed log with error messages occurred.

<Frame>
  <img alt="17.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUJ.png" />
</Frame>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/G6gDsyZ-bJM"
  width="560"
></iframe>
...
<Frame>
  <img alt="18.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUF.png" />
</Frame>

The column has been updated with a new Destination column name “2020 Warranty claims”.

<Frame>
  <img alt="19.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU9.png" />
</Frame>
...
<Frame>
  <img alt="20.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU4.png" />
</Frame>
...
<Frame>
  <img alt="21.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUP.png" />
</Frame>
...
<Frame>
  <img alt="22.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUQ.png" />
</Frame>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/lU-5yY3Nbko"
  width="560"
></iframe>
...
1. Visit the Overview tab of your job, and click the **Browse** button next to your DataSet name. Note that, you can also change your DataSet name here if you wish.
   ...
   <Frame>
     <img alt="23.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU6.png" />
   </Frame>
...
4. Here, select your connector DataSet, and click **Select**.
   ...
   <Frame>
     <img alt="24.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU8.png" />
   </Frame>
...
5. As you chose to update the Connector DataSet through Workbench, you will receive a warning as below saying that the Workbench will take over the connector schedule and stop further updates from the Connector for this DataSet.
   ...
   <Frame>
     <img alt="25.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUC.png" />
   </Frame>
...
8. For this change to take effect, save the job.
   <Frame>
     <img alt="26.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU0.png" />
   </Frame>
...
<Frame>
  <img alt="27.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUW.png" />
</Frame>
...
<iframe
  ...
  frameborder="0"
  height="315"
  src="//www.youtube-nocookie.com/embed/NN-OUANh3bM"
  width="560"
></iframe>
...
3. Confirm your request and click **Continue**.
   ...
   <Frame>
     <img alt="28.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU7.png" />
   </Frame>

4. The progress bar will appear showing the job execution progress, and the output will be displayed in the output window.

   <Frame>
     <img alt="29.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPU1.png" />
   </Frame>
...
5. Click the … (3dots) and select the local path to save your jobs at and click **Export Jobs**.
   ...
   <Frame>
     <img alt="30.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUY.png" />
   </Frame>
...
5. Select the desired option, and click **Continue**.
   ...
   <Frame>
     <img alt="31.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUB.png" />
   </Frame>
...
3. The Bulk Edit wizard will appear displaying the choices of changes you can make on jobs together. Here, select Edit provider settings and click **Continue**.
   ...
   <Frame>
     <img alt="32.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUS.png" />
   </Frame>
...
4. Now, the Bulk Edit wizard will display the fields that you can clear for the selected jobs. Select the Edit checkbox
   ...
   <Frame>
     <img alt="33.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUa-1.png" />
   </Frame>

5. The Bulk Edit wizard will ask you for the change confirmation. Click **Continue**.

   <Frame>
     <img alt="34.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUD.png" />
   </Frame>
...
7. Now, visit the **Configure** Tab of the jobs that you made changes to. You will see that the Source file path that you had selected earlier while configuring the job, doesn’t show up there anymore.
   <Frame>
     <img alt="35.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUM.png" />
   </Frame>
...
<Frame>
  <img alt="Database_Plugins.png" src="/images/kb/ka05w00000129sa-00N5w00000Ri7BU-0EM5w000005wL7l.png" />
</Frame>
...
2. In the **Configure** tab, click the **Edit** button under **Processing** (to set up a query.)
   ...
   <Frame>
     <img alt="Preocessing-Edit_button.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUV.png" />
   </Frame>

3. You’ll be able to see a tree structure of your data.

   <Frame>
     <img alt="Query_Tables.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUU.png" />
   </Frame>
...
<Frame>
  <img alt="Logging.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUH.png" />
</Frame>
...
<Frame>
  <img alt="Daily_Summary_Email.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPTv.png" />
</Frame>
...
1. Click **Settings**. The **Workbench Backup** section appears.
   ...
   <Frame>
     <img alt="Create_backup.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPUN.png" />
   </Frame>
...
2. Click the **Import backup**
   ...
   <Frame>
     <img alt="Import_backup.png" src="/images/kb/ka0Vq0000000zTJ-00N5w00000Ri7BU-0EM5w000005vPTy.png" />
   </Frame>
