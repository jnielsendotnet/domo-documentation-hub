...
* [Map DataSets to the app](#map_datasets_to_app)
* [Configure the app](#configure_app)
  + [Tabs](#tabs)
* [Tab settings](#tab_settings)
* [Use the app](#using)
* [Writing back changes](#write_back_changes)
* [Change log](#change_log)
* [Migrate to the new version of Inline Editing](#migrate_to_new_inline_editing)
...
1. Hover over the app to display
   <InlineImage src="/images/kb/ka05w00000127Q7-00N5w00000Ri7BU-0EM5w000005vsLM.jpg" /> **Card options** in the top right corner, and select it.
     
   The card options display.
2. Select
   <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbjQ.jpg" /> **Edit Card.**
...
<img src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wb8P.jpg" />
 ...
 4. At the bottom of the card editor, the data **Mapping** area displays. There are two sections: <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbjV.jpg" /> **DataSets** and <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbja.jpg" /> **Collections**.
...
5. Go to the
   <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbjV.jpg" /> **DataSets** section, if it is not already open.
...
1. At the bottom of the default screen, beside the tabs, admins seen the option to
   <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbks.jpg" /> **Add new tab.** If you do not see this option, you are not part of the admin group.
...
1. Select the tab you want to remove at the bottom of the app.
   ...
   The selected tab turns blue and displays a <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wblC.jpg" /> kebab menu beside the tab name.
...
To modify the settings for an active tab, admins can select <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhe.jpg" /> **Tab** **Settings** in the app toolbar.
...
* <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbmU.jpg" /> **Order —** Use these handles to drag and drop the columns to rearrange their order.

* <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbmZ.jpg" /> **Hide/View —** Toggle between making the columns visible or hiding them. When a column is hidden, the icon is grayed out.
...
* **editable —** Check this box to make the column editable by app users. An <InlineImage src="/images/kb/ka05w00000125lS-00N5w00000Ri7BU-0EM5w000005wtzY.jpg" /> **Edit** icon displays beside the column name in the column list.
...
* **pinned —** Check this box to pin the column to the top of the column list in the modal and to fix the column's position in the DataSet.
  ...
  In the modal, the <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbmU.jpg" /> **Order** option is not available for a pinned column.
...
To add a row, select <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbe1.jpg" /> **Switch to ADD mode**. A table in add mode displays.
  
To add a new row, select <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbeB.jpg" /> **Add new row**. A new row displays at the bottom of the table.
...
To mark a column for deletion the next time the DataSet is written back, select the <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wcHX.jpg" /> kebab menu for the row. Select **Mark for deletion**.

# Reset Row

If a row has changes in any field, you can reset the entire row by selecting the <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wcHX.jpg" /> kebab menu for the row and then selecting **Reset row changes.**

# Toolbar

The following table describes the toolbar options available on the app's default screen (Edit mode).

<table border="1" data-aura-rendered-by="33:201;a"><thead><tr><th colspan="1" rowspan="1"><b> Icon </b></th><th colspan="1" rowspan="1"><b> Description </b></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbfs.jpg" /></td><td colspan="1" rowspan="1"><b> App Filters — </b> Select this option to display the <b> Filter Data </b> modal. After applying a Filter, only the rows displayed are affected by manual or bulk edit changes. However, if changes have already been made before filtering the data, those changes are maintained and are applied when writing back to the DataSet. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbgR.jpg" /></td><td colspan="1" rowspan="1"><b> Discard changes </b><b> — </b> Resets all changes, from all pages, in the current DataSet. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbe1.jpg" /></td><td colspan="1" rowspan="1"><p><b> Switch to ADD mode — </b> Displays the table in add mode. </p><p> In add mode, the following option displays in the toolbar: </p><p><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbeB.jpg" /><b> Add new row — </b> Adds a new row to the bottom of the table. </p></td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wcIk.jpg" /></td><td colspan="1" rowspan="1"><b> Bulk Edit — </b> Allows users to edit all cells under a column at the same time. <br/><br/> Follow these steps to perform a bulk edit: <ol><li> Select <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wcIk.jpg" /><b> Bulk Edit </b> in the toolbar. The window displays. </li><li> Select the target column and new values for those columns. </li><li> Select <b> Apply </b>. To apply the changes, the app must download the entire DataSet in sections and apply the changes to each section. Depending on the size of the DataSet, this can take quite some time. A progress view displays to the user while the changes are being applied. Applying a Bulk Edit does not submit the changes. You must still write back to the DataSet manually. </li></ol></td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wcIu.jpg" /></td><td colspan="1" rowspan="1"><b> Bulk Delete — </b> Allows users to mark all cells under a column for deletion. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbh0.jpg" /></td><td colspan="1" rowspan="1"><p><b> Adjust font size — </b> Increase or decrease the font size with the controls, or select the font size from the list. </p><p> The last font size you select is stored locally. </p></td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhK.jpg" /></td><td colspan="1" rowspan="1"><b> Wrap Text — </b> Wraps the text in table cells. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhP.jpg" /></td><td colspan="1" rowspan="1"><b> Save Layout — </b> Saves the current table layout and displays it when the user returns to the app. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhU.jpg" /></td><td colspan="1" rowspan="1"><b> Reset Layout — </b> Resets the layout to the default configuration. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhZ.jpg" /> /td&gt; </td><td colspan="1" rowspan="1"><b> Enter fullscreen — </b> Opens the app in fullscreen mode. Select the button again to exit fullscreen </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhe.jpg" /></td><td colspan="1" rowspan="1"><b> Tab Settings — </b> Admins can use this option to access the <b> DataSet Settings </b>. </td></tr><tr><td colspan="1" rowspan="1"><InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbhj.jpg" /></td><td colspan="1" rowspan="1"><b> Help — </b> Opens the <b> Help </b> modal. Users can access this guide from inside the app. </td></tr></tbody></table>

### Sort Column

Sort the columns by selecting <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbf4.jpg" /> **Sort** for that column.

The first time you select <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbf4.jpg" /> **Sort**, the column sorts in ascending order. The second time, the column sorts in descending order. The third time resets the column.
  
Because you can sort multiple columns, a number next to the sort icon indicates the sorting priority, shown here: <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbfO.jpg" />
...
<Tip>
  **Tip:** To view a summary of the changes to that tab before selecting Write to DataSet, select <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005waXE.jpg" /> **Tab summary** to view the total rows in the DataSet, rows changed, and rows added.
...
1. Hover over the app to display
   ...
   The card options display.
2. Select
   <InlineImage src="/images/kb/ka0Vq00000055bl-00N5w00000Ri7BU-0EM5w000005wbjQ.jpg" /> **Edit Card** to open the card editor.
