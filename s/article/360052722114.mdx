...
| Region                                    | Select the AWS region where the AWS Data Exchange is available. Visit [AWS Regional Services List](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/) to get a detailed and updated list of the regions. |
