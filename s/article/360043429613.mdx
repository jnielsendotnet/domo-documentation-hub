...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| General > Show Summary Bars | Adds a summary column for each series in the chart. The screenshot shows an example of this, in which a summary column is provided for the bars for each individual date. Because the dates appear only on mouse-over, this is a good way of making the series for each date more distinguishable. | <img alt="waterfall_summary_bars.png" src="/images/kb/ka05w00000123lw-00N5w00000Ri7BU-0EM5w000005vP39.png"/> |
| General > Summary Text      | Lets you specify the text that appears below the summary bars. In the example, the user has replaced the word "Summary" with the word "Total."                                                                                                                                                     | <img alt="waterfall_summary_text.png" src="/images/kb/ka05w00000123lw-00N5w00000Ri7BU-0EM5w000005vP30.png"/> |
