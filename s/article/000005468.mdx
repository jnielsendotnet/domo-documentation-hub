...
| {" "}
 ...
 example, in the URL, 
 [{" "}
 https://docs.google.com/spreadsheets/d/12wVPoRgSLYcD1CBHpN4dpQiPHRNqV7azwGF4JbKoXaw/edit#gid=0,{" "}](https://docs.google.com/spreadsheets/d/12wVPoRgSLYcD1CBHpN4dpQiPHRNqV7azwGF4JbKoXaw/edit#gid=0,) 
 the spreadsheet ID is, 
 **12wVPoRgSLYcD1CBHpN4dpQiPHRNqV7azwGF4JbKoXaw**.{" "} |
| {" "}
 Worksheet Name{" "}             | {" "}
...
| {" "}
 Date Format{" "}                | Select the date format from the drop-down list.<br/>There are two date formats:<br/>Month Day Year (MMDDYYYY)<br/>Day Month Year (DDMMYYYY)                                                                                                                                                                                                                                                                                                       |
