...
| Field         | Description                                                          |
| ------------- | -------------------------------------------------------------------- |
| Client ID     | Enter the API Client ID associated with your OnBrand360 account.     |
| Client Secret | Enter the API Client Secret associated with your OnBrand360 account. |
| Username      | Enter the username associated with your OnBrand360 account.          |
| Password      | Enter the password associated with your OnBrand360 account.          |
| API URL       | Enter the API URL associated with your OnBrand360 account.           |
