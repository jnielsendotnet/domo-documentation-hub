...
* [General information](#general_information)
  ...
  + [Populate the resulting schema](#populate_the_schema)
...
* [API Reference](#api_reference)
  ...
  + [R API Reference](#r_api_reference)
* [Project Directory and /tmp Directory](#directories_in_scripting_tiles)
...
The total size of a Project Directory may not exceed eight gigabytes (8 GB). Contact [Domo Support](https://domo-support.domo.com/s/) <InlineImage src="/images/kb/ka0Vq00000001FR-00N5w00000Ri7BU-0EMVq0000000XDh.jpg" /> if you need to increase this limit, restore a directory from a backup, or copy a directory from one DataFlow to another.
