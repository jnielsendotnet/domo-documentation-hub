...
| Menu                               | Description                                                                                                                                                                                                                                                                 |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Input Domo DataSet ID              | Enter your Domo dataset ID (GUID) located in the dataset URL.<br/>Example: [https://customer.domo.com/datasources/](https://customer.domo.com/datasources/)**aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee** /details/settings                                                       |
| Input Source Domo DataSet Instance | Enter your input Domo dataset instance name located in the dataset URL.<br/>Example: https:// **customer**. [domo.com/datasources/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/details/settings](http://domo.com/datasources/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/details/settings) |
