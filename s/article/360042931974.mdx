...
| Menu      | Description                                                                                                                                                                                                                                                                                 |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| File Type | Select the file type for the file you want to import. In the standard version of the connector, only CSV, XLS, and XLSX files can be imported. If you want to import other file types such as JSON, XML, and ZIP files, use the [Dropbox File Advanced](/s/article/360043436553) connector. |
