...
* [Use the GROUP\_BY function](#use_group_by)
* [Aggregations using non-aggregated columns](#aggregation_using_non)
* [Grand total and sub-total rows](#grand_total_subtotal)
