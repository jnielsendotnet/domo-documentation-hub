...
| Menu   | Description                                                                                                                                                                        |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report | Select the report from the drop-down list.<br/>Availability<br/>CPULoad<br/>CPUCheck<br/>CurrentLoad<br/>DriveSpace<br/>HTTPResponse<br/>TotalProcesses<br/>MemoryUsage<br/>Uptime |
