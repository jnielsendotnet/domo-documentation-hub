...
9. (Optional) In Step 4 of the dialog, select the column to use as a partition, if any. (For an explanation of partitioning, see
   [Understanding partitions](#h_01F0MDK9T013ZZBRV63XCSJMYV "ETL Actions: Rank and Window") at the top of this page.)
...
For an explanation of partitioning, see [Understanding partitions](#h_01F0MDK9T013ZZBRV63XCSJMYV "ETL Actions: Rank and Window") at the top of this page.
