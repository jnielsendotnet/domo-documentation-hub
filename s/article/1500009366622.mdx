...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:206;a"><thead><tr><th colspan="1" rowspan="1"><p> Field </p></th><th colspan="1" rowspan="1"><p> Description </p></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"> Username </td><td colspan="1" rowspan="1"> Enter a valid username associated with an active account in the portal. </td></tr><tr><td colspan="1" rowspan="1"> Coprname </td><td colspan="1" rowspan="1"> Enter the client assigned hostname for your CornerStone OnDemand application (Corpname). </td></tr><tr><td colspan="1" rowspan="1"> API Key </td><td colspan="1" rowspan="1"> Enter the API Key. It can be retrieved from the Manage API tab in Integration Center. </td></tr><tr><td colspan="1" rowspan="1"> API Secret </td><td colspan="1" rowspan="1"> Enter the API Secret. It can be retrieved from the Manage API tab in Integration Center. </td></tr><tr><td colspan="1" rowspan="1"> Environment </td><td colspan="1" rowspan="1"> Select the environment (Pilot, Stage, or Production). </td></tr></tbody></table>
...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:206;a"><thead><tr><th colspan="1" rowspan="1"><p> Menu </p></th><th colspan="1" rowspan="1"><p> Description </p></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"><p> Views </p></td><td colspan="1" rowspan="1"><p> Select a view from the dropdown. The views that are accessible to you are dependent on your access level. </p></td></tr></tbody></table>
