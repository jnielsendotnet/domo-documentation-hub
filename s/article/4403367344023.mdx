...
<Note>**Note:** - The content must be owned or explicitly shared; not merely accessible via Domo Admin-level grants.
- If the repository has never been promoted, the user promoting the repository will be the owner of content created during the promotion.</Note>
