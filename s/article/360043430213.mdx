...
| Name               | Description                                                                                 |
| ------------------ | ------------------------------------------------------------------------------------------- |
| Page indicator     | Shows you the number of the currently displayed page and lets you navigate to other pages.  |
| Full-screen icon   | Opens the full-screen-width version of the file.                                            |
| Download icon      | Lets you download this file to your own computer.                                           |
| Close button       | Closes the reading view for the file.                                                       |
| Navigation buttons | Allow you to navigate from one page to the next if the file consists of more than one page. |
