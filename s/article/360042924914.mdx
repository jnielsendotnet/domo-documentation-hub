...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| General > Series Transparency | Determines the transparency for the fill areas in a radar chart. You can specify any value between `0` and `100`, where `0` means the fill areas are completely opaque and `100` means they have no fill at all. In the example, the transparency has been set to `20`. | [<img alt="" src="/images/kb/ka05w00000123mU-00N5w00000Ri7BU-0EM5w000005vP4j.png"/>](#) |
| Category Scale > Wrap Width   | Allows you to specify the number of pixels at which category labels will wrap in radar charts.                                                                                                                                                                          | —                                                                                       |
