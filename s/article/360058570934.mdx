...
| Field         | Description                                                                                                                                       |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Client ID     | Enter the Client ID associated with your Google Developers account. For more information, see [Prerequisites](#h_01ERQKRC5K0GG96DYQM5CSE2XZ).     |
| Client Secret | Enter the Client Secret associated with your Google Developers account. For more information, see [Prerequisites](#h_01ERQKRC5K0GG96DYQM5CSE2XZ). |
...
| Input Sheet ID   | Enter the Google Sheet ID that has been shared with the Service Account you created.<br/>Example: [https://docs.google.com/spreadsheets/d/](https://docs.google.com/spreadsheets/d/)** 18zN0RQ8HIaEj2USwtAkCMX7AKBl-x-_vq24kPd4_Tsk** /edit#gid=0 <br/>**NOTE** - All data in this sheet will be replaced |
