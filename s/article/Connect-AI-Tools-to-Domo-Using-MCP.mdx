...
{/* Screenshot placeholder: PDF page 2 — "Manage access tokens" panel showing the token description field, user search, expiration selector, and Generate button */}
...
{/* Screenshot placeholder: PDF page 3 — Claude Desktop app window showing the main chat interface */}

### Step 4: Edit the Claude Desktop configuration

In Claude Desktop, go to **Settings** > **Developer** and select **Edit Config**.

{/* Screenshot placeholder: PDF page 4 (top) — Claude Desktop Settings > Developer panel with the Edit Config button visible */}
...
{/* Screenshot placeholder: PDF page 4 (bottom) — macOS Finder window with claude_desktop_config.json selected, showing the file contents in the preview pane */}
...
{/* Screenshot placeholder: PDF page 5 — Claude Desktop app window (same as Step 3, showing the app after restart) */}

### Step 7: Verify the connection

Go to **Settings** > **Connectors** and confirm the Domo MCP server is listed and connected.

{/* Screenshot placeholder: PDF page 6 (top) — Settings > Connectors showing domo-mcp-npx listed alongside other connectors */}
...
{/* Screenshot placeholder: PDF page 6 (bottom) — domo-mcp-npx detail view showing Tool permissions with DomoSqlQueryTool, ExtendedThinkingTool, FileSetQueryTool, and SearchTool listed */}

To test the connection, try a prompt such as: "How many datasets do I have access to?"

{/* Screenshot placeholder: PDF page 7 (top) — Claude Desktop chat showing a response to "How many datasets do I have access to?" with a list of dataset categories */}
...
<Accordion title="What can I do once I'm connected?">
