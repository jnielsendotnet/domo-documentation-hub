...
| Menu                 | Description                                                               |
| -------------------- | ------------------------------------------------------------------------- |
| Properties Selection | Select whether to retrieve data for all properties or only specific ones. |
| Properties           | Select the properties for which you want to retrieve the data.            |
| Metrics              | Select at least one metric for your report.                               |
| Dimensions           | Select up to 9 dimensions for your report.                                |
