...
| Data Center URL | Select the Data Center URL of your account. See [Bullhorn documentation](https://bullhorn.github.io/Data-Center-URLs/) for more info. |
...
| Menu         | Description                                                                                                                                                                                                                                                                                                                                                     |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report       | Select the Bullhorn SOAP report you want to run. Currently only a single report type is available.<br/><table class="mt-responsive-table"><tbody><tr><td class="mt-noheading" colspan="1" rowspan="1"><p> Query Report </p></td><td class="mt-noheading" colspan="1" rowspan="1"><p> Lets you pull report data based on a query. </p></td></tr></tbody></table> |
