...
| Select Table Name | Select how you want to name the table where data will be copied.<br/>DataSet ID . The table name will be the number you entered for DataSet ID .{" "}<br/>DataSet Name . The table name will be the same as that of the input DataSet.{" "}<br/>Custom Name . You will give the table a custom name in the Custom Table Name field.{" "}                                                                                                                                                                                                                |
