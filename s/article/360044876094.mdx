...
* [Group By tile](#group_by_tile)
  + [Configure Group By tile](#configure_group_by_tile)
  + [Aggregation types](#aggregation_types)
  + [Use Group By tile in Magic ETL (video)](#use_group_by_video)
* [Rank & Window tile](#rank_and_window_tile)
  + [Understanding partitions](#understanding_partitions)
  + [Ranking functions](#ranking_functions)
    - [Rank](#rank)
    - [Dense rank](#dense_rank)
    - [Row number](#row_number)
  + [Framed functions](#framed_functions)
    - [Average](#average)
    - [Count](#count)
    - [Sum](#sum)
  + [Offset functions](#offset_functions)

    - [Lag](#lag)
    - [Lead](#lead)
  + [Rank & window functions in Magic ETL (video)](#rank_and_window_video)
