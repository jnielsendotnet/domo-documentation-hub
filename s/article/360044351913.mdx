...
| Menu                       | Description                                                                                                                                                                                                                                                                                                                                         |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report                     | Select the HasOffers report you want to run. Currently only a single report is available.<br/><table border="1" cellpadding="1" cellspacing="1"><tbody><tr><td colspan="1" rowspan="1"><p> Stats Report </p></td><td colspan="1" rowspan="1"><p> Returns Affiliate Report statistics based on selected fields. </p></td></tr></tbody></table>       |
