...
This article provides information on Domo Workbench training in the following topics:

[Migration and Updates](#migration-and-updates)

* [Check my current version](#check-my-current-version)
* [Automatic updates](#automatic-updates)
* [Upgrade to Workbench 5](#upgrade-to-workbench-5)

[Manage the Job Queue](#manage-the-job-queue)

* [Limit concurrent jobs](#limit-concurrent-jobs)
* [Run job process as below normal priority](#run-job-process-at-below-normal)
* [Cancel a currently running job](#cancel-a-currently-running-job)
* [Manually run a job](#manually-run-a-job)

[Impersonation](#impersonation)

* [Turn on impersonation](#turn-on-impersonation)
