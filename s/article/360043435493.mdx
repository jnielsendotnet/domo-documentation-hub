...
| **Primary Use Cases**                                     | This connector is useful for getting severe weather alerts when planning outside events.              |
| --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **Primary Company Roles**                                 | HR roles, especially those involved in event planning<br/>Anyone interested in getting weather alerts |
...
| Field      | Description                                                                     |
| ---------- | ------------------------------------------------------------------------------- |
| State Name | Select the State from the dropdown that you want to receive weather alerts for. |
