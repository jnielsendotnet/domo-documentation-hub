...
| Use BigDecimal (checkbox)                     | Select this checkbox to use BigDecimal for all numeric values. This option is useful for preserving precision when working with large numbers. Select this option if your data contains numbers with more than 9 decimal places.                                                                                                                                                                                                                                                                                       |
| Keep Special Characters in Headers (checkbox) | Select this checkbox to keep Special Characters in headers. If this option is not selected and headers of columns contains special characters then these will get replaced with underscore in the generated BigQuery Table.                                                                                                                                                                                                                                                                                            |
