...
| Field              | Description                                                                                                                                                                        |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Hostname           | Enter your MongoDB database hostname or IP address.                                                                                                                                |
...
| Certificate Format | {" "}
 Select a certificate type. This must match what you enter in the ** Certificate**
...
| Collection Name Source | Select how you want to name the collection where data will be copied.<br/>DataSet ID . The collection name will be the number you entered for Input DataSet ID {" "}
 .{" "}<br/>DataSet Name . The table name will be the same as that of the input DataSet.{" "}<br/>Custom Name . You will give the table a custom name in the Custom Table Name field.{" "}                                                                                                                                                                                           |
