...
| Menu            | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Query           | To select the data you want to import, enter a **Structured Query Language (SQL) query** into the **Query** field.<br/>**Using the Query Helper**<br/>If you need assistance in creating a simple query, use the **Query Helper** :<br/>Select the desired database table from the dropdown menu.<br/>Select the columns you wish to ingest into Domo.<br/>The completed SQL query will appear in the Query Helper box .<br/>Copy the generated query from the Query Helper box and paste it into the Query field.                                                                                                                                                                |
| Database Tables | If you already have your query, you can ignore this section and enter it directly into the **Query** field. The **Query Helper** assists you in building a basic SQL query.<br/>**Steps to Generate a Query**<br/>Follow these steps to generate a query using the Query Helper:<br/>Select the database table that contains the data you want to ingest. A list of columns for the selected table will appear.<br/>Select the columns you are interested in.<br/>The generated SQL query will automatically appear in the Query Helper box .<br/>Copy the generated query from the Query Helper box and **paste** it into the required **Query** field at the top of the screen. |
...
| Query Helper    | The **Query Helper** field displays a sample SQL query based on the columns you select in the **Table Columns** field.<br/>When you select a column, it is immediately included in the query. Selecting additional columns adds them to the existing query.<br/>You can edit the sample query directly in this field as needed.<br/>After building or modifying the query here, copy it and paste it into the main Query field to retrieve your data.                                                                                                                                                                                                                             |
