...
This article provides information about setting up MFA in your instance in the following topics:

* [Multi-factor authentication and SSO](#multi-factor_authentication_and_sso)
* [Configure multi-factor authentication for your organization](#configure_mfa_for_your_organization)
* [Configure multi-factor authentication for yourself](#configure_multi-factor_authentication_for_yourself)
* [FAQ](#faq)
* [Multi-factor authentication (video)](#video)
