...
* [Create a DataSet alert](#create_a_dataset_alert)
* [Set up an alert rule](#set_up_alert_rule)
  + [Individual row alerts](#individual_row_alerts)
  + [Column aggregation alerts](#column_aggregation_alerts)
  + [Specify the alert frequency](#specify_alert_frequency)
* [Customize an alert message](#customize_alert_message)
* [Attach an action](#attach_an_action)
  + [Webhook action](#webhook_action)
  + [Task creation action](#task_creation_action)
  + [Scheduled report action](#scheduled_report)
* [Share an alert](#share_an_alert)
* [Save an alert](#save_an_alert)
* [Edit an alert](#edit_an_alert)
* Videos
  + [Using DataSet Alerts](#using_dataset_alerts)
  + [Sharing Alerts](#sharing_alerts)
...
<Warning>
  **Important:** To send a Scheduled Report triggered by an alert you need three levels of access:
...
1. In the Details view for the card with the Alert, click the
   <InlineImage src="/images/kb/ka0Vq000000Go8v-00N5w00000Ri7BU-0EM5w000005vOc8.png" /> icon to show the Alerts for this card.
