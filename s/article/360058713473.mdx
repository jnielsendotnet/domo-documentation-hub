...
| Replica Set Name   | Enter the replica set name of your MongoDB cluster.                                                                                                         |
| Read Preference    | Select appropriate Read Preference to route the Read operation to the members of a replica set.                                                             |
