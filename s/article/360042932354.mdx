...
| Hostname           | Enter the hostname where you want to post the data from your Domo dataset. <br/> Example: If your URL is **[https://host/sample/path](https://host/sample/path)** then enter, **[https://host](https://host)**. |
