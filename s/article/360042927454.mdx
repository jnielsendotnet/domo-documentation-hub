...
| Menu                       | Description                                                                                                                                                                                                                                                                                                                                         |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Report                     | Select the Synthesio report you want to run.<br/><table border="1" cellpadding="1" cellspacing="1"><tbody><tr><td colspan="1" rowspan="1"> Synthesio Plus Twitter Report </td><td colspan="1" rowspan="1"> Returns tweet IDs from Synthesio dashboards then rehydrates the data using the Twitter API. </td></tr></tbody></table>                   |
